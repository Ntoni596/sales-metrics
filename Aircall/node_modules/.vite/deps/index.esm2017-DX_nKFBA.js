...
function setUserLogHandler(logCallback, options) {
	for (const instance of instances) {
		...
		if (logCallback === null) instance.userLogHandler = null;
			...
			if (level >= (customLogLevel !== null && customLogLevel !== void 0 ? customLogLevel : instance$1.logLevel)) logCallback({
...
//#endregion
export { createMockUserToken as A, isSafariOrWebkit as B, LogLevel as C, FirebaseError as D, ErrorFactory as E, getUA as F, updateEmulatorBanner as H, isBrowserExtension as I, isCloudWorkstation as L, getDefaultEmulatorHostnameAndPort as M, getGlobal as N, areCookiesEnabled as O, getModularInstance as P, isIndexedDBAvailable as R, openDB as S, Component as T, validateIndexedDBOpenable as U, pingServer as V, initializeApp as _, _apps as a, registerVersion as b, _getProvider as c, _registerComponent as d, _removeServiceInstance as f, getApps as g, getApp as h, _addOrOverwriteComponent as i, deepEqual as j, calculateBackoffMillis as k, _isFirebaseApp as l, deleteApp as m, SDK_VERSION as n, _clearComponents as o, _serverApps as p, _addComponent as r, _components as s, DEFAULT_ENTRY_NAME as t, _isFirebaseServerApp as u, initializeServerApp as v, Logger as w, setLogLevel$1 as x, onLog as y, isSafari as z };
//# sourceMappingURL=index.esm2017-DX_nKFBA.js.map