import { A as createMockUserToken, B as isSafariOrWebkit, C as LogLevel, D as FirebaseError, F as getUA, H as updateEmulatorBanner, L as isCloudWorkstation, M as getDefaultEmulatorHostnameAndPort, N as getGlobal, P as getModularInstance, R as isIndexedDBAvailable, T as Component, V as pingServer, b as registerVersion, c as _getProvider, d as _registerComponent, f as _removeServiceInstance, h as getApp, j as deepEqual, n as SDK_VERSION, u as _isFirebaseServerApp, w as Logger, z as isSafari } from "./index.esm2017-EfusZGUJ.js";
...
(function() {
	...
	function y(f, a) {
		...
		if ("-" == f.charAt(0)) return x$1(y(f.substring(1), a));
	...
	h.toString = function(f) {
		...
		if (C(this)) return "0";
		if (B$1(this)) return "-" + x$1(this).toString(f);
	...
	h.l = function(f) {
		f = F$1(this, f);
		return B$1(f) ? -1 : C(f) ? 0 : 1;
	};
	function x$1(f) {
		for (var a = f.g.length, c = [], d = 0; d < a; d++) c[d] = ~f.g[d];
		return new t(c, ~f.h).add(z$1);
	}
	h.abs = function() {
	...
	h.j = function(f) {
		...
		if (B$1(this)) return B$1(f) ? x$1(this).j(x$1(f)) : x$1(x$1(this).j(f));
		if (B$1(f)) return x$1(this.j(x$1(f)));
	...
	function D(f, a) {
		...
		if (C(f)) return new H$1(w, w);
		if (B$1(f)) return a = D(x$1(f), a), new H$1(x$1(a.g), x$1(a.h));
		if (B$1(a)) return a = D(f, x$1(a)), new H$1(x$1(a.g), a.h);
		if (30 < f.g.length) {
			if (B$1(f) || B$1(a)) throw Error("slowDivide_ only works with positive integers.");
			for (var c = z$1, d = a; 0 >= d.l(f);) c = I(c), d = I(d);
			var e = J$1(c, 1), g = J$1(d, 1);
			d = J$1(d, 2);
			for (c = J$1(c, 2); !C(d);) {
				var b = g.add(d);
		...
		for (e = w; 0 <= f.l(a);) {
			...
			g = v(c);
			for (b = g.j(a); B$1(b) || 0 < b.l(f);) c -= d, g = v(c), b = g.j(a);
			C(g) && (g = z$1);
			e = e.add(g);
			f = F$1(f, b);
		}
...
(function() {
	...
	let x$1, y = !1, za = new Aa(), Ea = () => {
		const a = k$1.Promise.resolve(void 0);
		x$1 = () => {
			a.then(Da);
		};
	};
	...
	z$1.prototype.s = !1;
	z$1.prototype.ma = function() {
		this.s || (this.s = !0, this.N());
	};
	z$1.prototype.N = function() {
	...
	var Fa = function() {
		if (!k$1.addEventListener || !Object.defineProperty) return !1;
		var a = !1, b = Object.defineProperty({}, "passive", { get: function() {
			a = !0;
		} });
		try {
			const c = () => {};
			k$1.addEventListener("test", c, b);
			k$1.removeEventListener("test", c, b);
		} catch (c) {}
		return a;
	}();
	function C(a, b) {
	...
	function ab(a, b, c, d) {
		...
		for (var e = !0, f = 0; f < b.length; ++f) {
			...
			if (g && !g.da && g.capture == c) {
				var m = g.listener, q$1 = g.ha || g.src;
				g.fa && Ma(a.i, g);
				e = !1 !== m.call(q$1, d) && e;
			}
		}
	...
	class eb extends z$1 {
		...
		N() {
			super.N();
			this.g && (k$1.clearTimeout(this.g), this.g = null, this.i = !1, this.h = null);
		}
	}
	function G$1(a) {
		z$1.call(this);
	...
	G$1.prototype.N = function() {
		G$1.aa.N.call(this);
		gb(this);
	};
	G$1.prototype.handleEvent = function() {
		throw Error("EventHandler.handleEvent not implemented");
	};
	var hb = k$1.JSON.stringify;
	var ib = k$1.JSON.parse;
	var jb = class {
		stringify(a) {
	...
	function wb(a, b, c, d, e, f) {
		a.info(function() {
			if (a.g) if (f) {
				var g = "";
				for (var m = f.split("&"), q$1 = 0; q$1 < m.length; q$1++) {
					var l = m[q$1].split("=");
					if (1 < l.length) {
						var v = l[0];
						l = l[1];
	...
	M$1.prototype.ca = function(a) {
		a = a.target;
		const b = this.M;
		b && 3 == P(a) ? b.j() : this.Y(a);
	};
	M$1.prototype.Y = function(a) {
		try {
			if (a == this.g) a: {
				const w = P(this.g);
				var b = this.g.Ba();
				...
				if (!(3 > w) && (3 != w || this.g && (this.h.h || this.g.oa() || Nb(this.g)))) {
					this.J || 4 != w || 7 == b || (8 == b || 0 >= O$1 ? J$1(3) : J$1(2));
					Ob(this);
					var c = this.g.Z();
					this.X = c;
					b: if (Pb(this)) {
					...
					if (this.o) {
						if (this.T && !this.K) {
							b: {
								if (this.g) {
									var m, q$1 = this.g;
									if ((m = q$1.g ? q$1.g.getResponseHeader("X-HTTP-Initial-Response") : null) && !t(m)) {
										var l = m;
										break b;
									}
								}
							...
							if (c = l) L$1(this.i, this.l, c, "Initial handshake response via X-HTTP-Initial-Response"), this.K = !0, Rb(this, c);
							else {
								this.o = !1;
								this.s = 3;
								K$1(12);
						...
						if (this.P) {
							c = !0;
							let B$1;
							for (; !this.J && this.C < g.length;) if (B$1 = Sb(this, g), B$1 == Gb) {
								4 == w && (this.s = 4, K$1(14), c = !1);
								L$1(this.i, this.l, null, "[Incomplete Response]");
								break;
							} else if (B$1 == Fb) {
								this.s = 4;
								K$1(15);
								L$1(this.i, this.l, g, "[Invalid Chunk]");
								c = !1;
								break;
							} else L$1(this.i, this.l, B$1, null), Rb(this, B$1);
							Pb(this) && 0 != this.C && (this.h.g = this.h.g.slice(this.C), this.C = 0);
							4 != w || 0 != g.length || this.h.h || (this.s = 1, K$1(16), c = !1);
							this.o = this.o && c;
							if (!c) L$1(this.i, this.l, g, "[Invalid Chunked Response]"), Q$1(this), Qb(this);
							else if (0 < g.length && !this.W) {
								this.W = !0;
								var v = this.j;
								v.g == this && v.ba && !v.M && (v.j.info("Great, no buffering proxy detected. Bytes received: " + g.length), Tb(v), v.M = !0, K$1(11));
							}
						} else L$1(this.i, this.l, g, null), Rb(this, g);
						4 == w && Q$1(this);
						this.o && !this.J && (4 == w ? Ub(this.j, this) : (this.o = !1, Kb(this)));
					} else Vb(this.g), 400 == c && 0 < g.indexOf("Unknown SID") ? (this.s = 3, K$1(12)) : (this.s = 0, K$1(13)), Q$1(this), Qb(this);
				}
			}
		} catch (w) {}
	};
	...
	function Ob(a) {
		a.B && (k$1.clearTimeout(a.B), a.B = null);
	}
	M$1.prototype.ba = function() {
		this.B = null;
		const a = Date.now();
		0 <= a - this.S ? (zb(this.i, this.A), 2 != this.L && (J$1(), K$1(17)), Q$1(this), this.s = 2, Qb(this)) : Wb(this, this.S - a);
	};
	function Qb(a) {
			...
			if (0 != c.G && (c.g == a || Xb(c.h, a))) {
				if (!a.K && Xb(c.h, a) && 3 == c.G) {
					...
					if (2 == c.G) if ("c" == l[0]) {
						...
						const O$1 = l[5];
						null != O$1 && "number" === typeof O$1 && 0 < O$1 && (d = 1.5 * O$1, c.L = d, c.j.info("backChannelRequestTimeoutMs_=" + d));
						d = c;
						const B$1 = a.g;
						if (B$1) {
							const ya = B$1.g ? B$1.g.getResponseHeader("X-Client-Wire-Protocol") : null;
							if (ya) {
								var f = d.h;
								f.g || -1 == ya.indexOf("spdy") && -1 == ya.indexOf("quic") && -1 == ya.indexOf("h2") || (f.j = f.l, f.g = /* @__PURE__ */ new Set(), f.h && (bc(f, f.h), f.h = null));
							}
							if (d.D) {
								const db = B$1.g ? B$1.g.getResponseHeader("X-HTTP-Session-Id") : null;
	...
	function ic(a) {
		this.l = a || 10;
		k$1.PerformanceNavigationTiming ? (a = k$1.performance.getEntriesByType("navigation"), a = 0 < a.length && ("hq" == a[0].nextHopProtocol || "h2" == a[0].nextHopProtocol)) : a = !!(k$1.chrome && k$1.chrome.loadTimes && k$1.chrome.loadTimes() && k$1.chrome.loadTimes().wasFetchedViaSpdy);
		this.j = a ? this.l : 1;
		this.g = null;
	...
	function Fc(a, b) {
		...
		if (k$1.Image) {
			const d = new Image();
			d.onload = ka(W$1, c, "TestLoadImage: loaded", !0, b, d);
			d.onerror = ka(W$1, c, "TestLoadImage: error", !1, b, d);
			d.onabort = ka(W$1, c, "TestLoadImage: abort", !1, b, d);
			d.ontimeout = ka(W$1, c, "TestLoadImage: timeout", !1, b, d);
	...
	h.send = function(a) {
		...
		a && (b.body = a);
		(this.D || k$1).fetch(new Request(this.A, b)).then(this.Sa.bind(this), this.ga.bind(this));
	};
	h.abort = function() {
	...
	h.Sa = function(a) {
		...
		else if ("undefined" !== typeof k$1.ReadableStream && "body" in a) {
	...
	h.ea = function(a, b, c, d) {
		...
		e = k$1.FormData && a instanceof k$1.FormData;
	...
	function Uc(a) {
		a.A || (a.A = !0, F$1(a, "complete"), F$1(a, "error"));
	}
	h.abort = function(a) {
		this.g && this.h && (this.h = !1, this.j = !0, this.g.abort(), this.j = !1, this.m = a || 7, F$1(this, "complete"), F$1(this, "abort"), Vc(this));
	};
	h.N = function() {
	...
	function Wc(a) {
		if (a.h && "undefined" != typeof fa && (!a.v[1] || 4 != P(a) || 2 != a.Z())) {
			...
			else if (F$1(a, "readystatechange"), 4 == P(a)) {
				a.h = !1;
				try {
					const g = a.Z();
					a: switch (g) {
					...
					if (!(c = b)) {
						...
						if (d = 0 === g) {
							...
							!e && k$1.self && k$1.self.location && (e = k$1.self.location.protocol.slice(0, -1));
							d = !Qc.test(e ? e.toLowerCase() : "");
						}
						c = d;
					}
					if (c) F$1(a, "complete"), F$1(a, "success");
					else {
						a.m = 6;
						try {
	...
	function Tc(a) {
		a.I && (k$1.clearTimeout(a.I), a.I = null);
	}
	h.isActive = function() {
		return !!this.g;
	};
	...
	function gc(a) {
		...
		if (3 == a.G) {
			...
			b.v = Ib(N$1(c));
			c = !1;
			if (k$1.navigator && k$1.navigator.sendBeacon) try {
				c = k$1.navigator.sendBeacon(b.v.toString(), "");
			} catch (d) {}
			!c && k$1.Image && (new Image().src = b.v, c = !0);
	...
	function Zc(a) {
		Zb(a);
		a.u && (k$1.clearTimeout(a.u), a.u = null);
		Yb(a);
		a.h.cancel();
		a.s && ("number" === typeof a.s && k$1.clearTimeout(a.s), a.s = null);
	}
	function fc(a) {
		if (!jc(a.h) && !a.s) {
			a.s = !0;
	...
	function dd(a, b, c) {
		...
		a: {
			...
			for (;;) {
				...
				let m = !0;
				for (let q$1 = 0; q$1 < c; q$1++) {
					let l = e[q$1].g;
					const v = e[q$1].map;
					l -= f;
					if (0 > l) f = Math.max(0, e[q$1].g - 100), m = !1;
					else try {
						Ic(v, g, "req" + l + "_");
					} catch (w) {
						d && d(v);
	...
	h.ab = function() {
		this.A && (this.A = null, this.j.info("BP detection timeout reached."), this.j.info("Buffering proxy detected and switch to long-polling!"), this.F = !1, this.M = !0, K$1(10), Zb(this), fd(this));
	};
	function Tb(a) {
		null != a.A && (k$1.clearTimeout(a.A), a.A = null);
	}
	function fd(a) {
		a.g = new M$1(a, a.j, "rpc", a.Y);
		null === a.m && (a.g.H = a.o);
		a.g.O = 0;
		var b = N$1(a.qa);
		S(b, "RID", "rpc");
	...
	h.Za = function() {
		null != this.C && (this.C = null, Zb(this), $b(this), K$1(19));
	};
	function Yb(a) {
		null != a.C && (k$1.clearTimeout(a.C), a.C = null);
	}
	function Ub(a, b) {
		var c = null;
		if (a.g == b) {
	...
	function R(a, b) {
		...
		if (2 == b) {
			...
			k$1.location && "http" == k$1.location.protocol || qc(d, "https");
			Ib(d);
	...
	h.fb = function(a) {
		a ? (this.j.info("Successfully pinged google.com"), K$1(2)) : (this.j.info("Failed to ping google.com"), K$1(1));
	};
	function ad(a) {
		a.G = 0;
		a.ka = [];
	...
	function cc(a, b, c) {
		var d = c instanceof T ? N$1(c) : new T(c);
	...
	function Mb(a, b, c) {
		...
		b = a.Ca && !a.pa ? new X$1(new Jc({ eb: c })) : new X$1(a.pa);
		b.Ha(a.J);
		return b;
	}
	h.isActive = function() {
	...
	X$1.prototype.listenOnce = X$1.prototype.L;
	X$1.prototype.getLastError = X$1.prototype.Ka;
	X$1.prototype.getLastErrorCode = X$1.prototype.Ba;
	X$1.prototype.getStatus = X$1.prototype.Z;
	X$1.prototype.getResponseJson = X$1.prototype.Oa;
	X$1.prototype.getResponseText = X$1.prototype.oa;
	X$1.prototype.send = X$1.prototype.ea;
	X$1.prototype.setWithCredentials = X$1.prototype.Ha;
	XhrIo = webchannel_blob_es2018.XhrIo = X$1;
}).apply(typeof commonjsGlobal !== "undefined" ? commonjsGlobal : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});

//#endregion
//#region node_modules/@firebase/firestore/dist/index.esm2017.js
var F = "@firebase/firestore", M = "4.8.0";
/**
* @license
	...
	*/ async k(e) {
		return this.db || (__PRIVATE_logDebug(U, "Opening database:", this.name), this.db = await new Promise(((t, n) => {
			...
			r.onsuccess = (e$1) => {
				...
				__PRIVATE_logDebug(U, "Database \"" + this.name + "\" requires upgrade from version:", e$1.oldVersion);
				const t$1 = e$1.target.result;
				if (null !== this.L && this.L !== e$1.oldVersion) throw new Error(`refusing to open IndexedDB database due to potential corruption of the IndexedDB database data; this corruption could be caused by clicking the "clear site data" button in a web browser; try reloading the web page to re-initialize the IndexedDB database: lastClosedDbVersion=${this.L}, event.oldVersion=${e$1.oldVersion}, event.newVersion=${e$1.newVersion}, db.version=${t$1.version}`);
				this.B.q(t$1, r.transaction, e$1.oldVersion, this.version).next((() => {
					__PRIVATE_logDebug(U, "Database upgrade to version " + this.version + " complete");
				}));
			};
		})), this.db.addEventListener("close", ((e$1) => {
			this.L = e$1.target.version;
		}), { passive: !0 })), this.db.addEventListener("versionchange", ((e$1) => {
			var t;
			null === e$1.newVersion && (__PRIVATE_logWarn("Received \"versionchange\" event with newVersion===null; notifying the registered DatabaseDeletedListener, if any"), null === (t = this.databaseDeletedListener) || void 0 === t || t.call(this));
		}), { passive: !0 }), this.db;
	}
	...
	async runTransaction(e, t, n, r) {
		...
		for (;;) {
			...
			try {
				...
				const t$1 = __PRIVATE_SimpleDbTransaction.open(this.db, e, i ? "readonly" : "readwrite", n), s$1 = r(t$1).next(((e$1) => (t$1.v(), e$1))).catch(((e$1) => (t$1.abort(e$1), PersistencePromise.reject(e$1)))).toPromise();
				return s$1.catch((() => {})), await t$1.D, s$1;
			} catch (e$1) {
				const t$1 = e$1, n$1 = "FirebaseError" !== t$1.name && s < 3;
				if (__PRIVATE_logDebug(U, "Transaction failed with error:", t$1.message, "Retrying:", n$1), this.close(), !n$1) return Promise.reject(t$1);
			}
		}
	}
	close() {
...
*/ var __PRIVATE_SimpleDbStore = class {
	...
	*/ get(e) {
		return __PRIVATE_wrapRequest(this.store.get(e)).next(((t) => (void 0 === t && (t = null), __PRIVATE_logDebug(U, "GET", this.store.name, e, t), t)));
	}
	delete(e) {
	...
	*/ ee(e) {
		...
		return new PersistencePromise(((n, r) => {
			t.onerror = (e$1) => {
				r(__PRIVATE_checkForAndReportiOSError(e$1.target.error));
			}, t.onsuccess = (t$1) => {
	...
	J(e, t) {
		...
		return new PersistencePromise(((r, i) => {
			e.onerror = (e$1) => {
				...
				s.isDone ? r() : null === s.W ? i$1.continue() : i$1.continue(s.W);
			};
...
*/ function __PRIVATE_wrapRequest(e) {
	return new PersistencePromise(((t, n) => {
		e.onsuccess = (e$1) => {
			...
			n(__PRIVATE_checkForAndReportiOSError(e$1.target.error));
		};
	}));
}
var K = !1;
...
var __PRIVATE_IndexBackfillerScheduler = class {
	...
	ne(e) {
		__PRIVATE_logDebug(W, `Scheduled in ${e}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill", e, (async () => {
			this.task = null;
			try {
				__PRIVATE_logDebug(W, `Documents written: ${await this.te.re()}`);
			} catch (e$1) {
				__PRIVATE_isIndexedDbTransactionError(e$1) ? __PRIVATE_logDebug(W, "Ignoring IndexedDB error during index backfill: ", e$1) : await __PRIVATE_ignoreIfPrimaryLeaseLoss(e$1);
			}
			await this.ne(6e4);
		}));
	}
...
/** Implements the steps for backfilling indexes. */ var __PRIVATE_IndexBackfiller = class {
	...
	/** Writes index entries until the cap is reached. Returns the number of documents processed. */ ie(e, t) {
		...
		return PersistencePromise.doWhile((() => !0 === i && r > 0), (() => this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next(((t$1) => {
			if (null !== t$1 && !n.has(t$1)) return __PRIVATE_logDebug(W, `Processing collection: ${t$1}`), this.se(e, t$1, r).next(((e$1) => {
				r -= e$1, n.add(t$1);
			}));
			i = !1;
		})))).next((() => t - r));
	...
	*/ se(e, t, n) {
		return this.localStore.indexManager.getMinOffsetFromCollectionGroup(e, t).next(((r) => this.localStore.localDocuments.getNextDocuments(e, t, r, n).next(((n$1) => {
			const i = n$1.changes;
			return this.localStore.indexManager.updateIndexEntries(e, i).next((() => this.oe(r, n$1))).next(((n$2) => (__PRIVATE_logDebug(W, `Updating offset: ${n$2}`), this.localStore.indexManager.updateCollectionGroup(e, t, n$2)))).next((() => i.size));
		}))));
	}
...
*/ var __PRIVATE_ListenSequence = class {
	constructor(e, t) {
		this.previousValue = e, t && (t.sequenceNumberHandler = (e$1) => this._e(e$1), this.ae = (e$1) => t.writeSequenceNumber(e$1));
	}
	_e(e) {
...
*/ function __PRIVATE_decodeResourcePath(e) {
	const t = e.length;
	if (__PRIVATE_hardAssert(t >= 2, 64408, { path: e }), 2 === t) return __PRIVATE_hardAssert(e.charAt(0) === z && "" === e.charAt(1), 56145, { path: e }), ResourcePath.emptyPath();
	const __PRIVATE_lastReasonableEscapeIndex = t - 2, n = [];
	let r = "";
	for (let i = 0; i < t;) {
		const t$1 = e.indexOf(z, i);
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var j = "remoteDocuments", J = "owner", H = "owner", Y = "mutationQueues", Z = "userId", X = "mutations", ee = "batchId", te = "userMutationsIndex", ne = ["userId", "batchId"];
/**
* @license
* Copyright 2022 Google LLC
*
...
* information.
*/ var re = {}, ie = "documentMutations", se = "remoteDocumentsV14", oe = [
	"prefixPath",
	"collectionGroup",
	"readTime",
	"documentId"
...
*/ var ByteString = class ByteString {
	...
	static fromBase64String(e) {
		return new ByteString(function __PRIVATE_decodeBase64(e$1) {
			try {
				return atob(e$1);
			} catch (e$2) {
	...
	static fromUint8Array(e) {
		return new ByteString(
			...
			*/
			function __PRIVATE_binaryStringFromUint8Array(e$1) {
				let t = "";
...
*   localWriteTime.
*/ var st = "server_timestamp", ot = "__type__", _t = "__previous_value__", at = "__local_write_time__";
...
/** The default database name for a project. */ var ut = "(default)";
/**
...
* limitations under the License.
*/
var ct = "__type__", lt = "__max__", ht = { mapValue: { fields: { __type__: { stringValue: lt } } } }, Pt = "__vector__", Tt = "value", It = { nullValue: "NULL_VALUE" };
...
function __PRIVATE_valueCompare(e, t) {
	...
	switch (n) {
		...
		case 10: return function __PRIVATE_compareVectors(e$1, t$1) {
			var n$1, r$1, i, s;
			const o = e$1.fields || {}, _ = t$1.fields || {}, a = null === (n$1 = o[Tt]) || void 0 === n$1 ? void 0 : n$1.arrayValue, u = null === (r$1 = _[Tt]) || void 0 === r$1 ? void 0 : r$1.arrayValue, c = __PRIVATE_primitiveComparator((null === (i = null == a ? void 0 : a.values) || void 0 === i ? void 0 : i.length) || 0, (null === (s = null == u ? void 0 : u.values) || void 0 === s ? void 0 : s.length) || 0);
			if (0 !== c) return c;
			return __PRIVATE_compareArrays(a, u);
		}(e.mapValue, t.mapValue);
		case 11: return function __PRIVATE_compareMaps(e$1, t$1) {
			if (e$1 === ht.mapValue && t$1 === ht.mapValue) return 0;
			if (e$1 === ht.mapValue) return 1;
			if (t$1 === ht.mapValue) return -1;
...
var dt = { mapValue: { fields: {
	[ct]: { stringValue: Pt },
	[Tt]: { arrayValue: {} }
} } };
/** Returns the lowest value for the given value type (inclusive). */ function __PRIVATE_valuesGetLowerBound(e) {
	return "nullValue" in e ? It : "booleanValue" in e ? { booleanValue: !1 } : "integerValue" in e || "doubleValue" in e ? { doubleValue: NaN } : "timestampValue" in e ? { timestampValue: { seconds: Number.MIN_SAFE_INTEGER } } : "stringValue" in e ? { stringValue: "" } : "bytesValue" in e ? { bytesValue: "" } : "referenceValue" in e ? __PRIVATE_refValue(DatabaseId.empty(), DocumentKey.empty()) : "geoPointValue" in e ? { geoPointValue: {
		latitude: -90,
		longitude: -180
	} } : "arrayValue" in e ? { arrayValue: {} } : "mapValue" in e ? __PRIVATE_isVectorValue(e) ? dt : { mapValue: {} } : fail(35942, { value: e });
}
/** Returns the largest value for the given value type (exclusive). */ function __PRIVATE_valuesGetUpperBound(e) {
	return "nullValue" in e ? { booleanValue: !1 } : "booleanValue" in e ? { doubleValue: NaN } : "integerValue" in e || "doubleValue" in e ? { timestampValue: { seconds: Number.MIN_SAFE_INTEGER } } : "timestampValue" in e ? { stringValue: "" } : "stringValue" in e ? { bytesValue: "" } : "bytesValue" in e ? __PRIVATE_refValue(DatabaseId.empty(), DocumentKey.empty()) : "referenceValue" in e ? { geoPointValue: {
		latitude: -90,
		longitude: -180
	} } : "geoPointValue" in e ? { arrayValue: {} } : "arrayValue" in e ? dt : "mapValue" in e ? __PRIVATE_isVectorValue(e) ? { mapValue: {} } : ht : fail(61959, { value: e });
}
...
function __PRIVATE_extractDocumentKeysFromArrayValue(e, t) {
	var n;
	return ((null === (n = t.arrayValue) || void 0 === n ? void 0 : n.values) || []).map(((e$1) => DocumentKey.fromName(e$1.referenceValue)));
}
...
function __PRIVATE_canonifyTarget(e) {
	...
	if (null === t.Pe) {
		...
		}(e$2))).join(","), __PRIVATE_isNullOrUndefined(t.limit) || (e$1 += "|l:", e$1 += t.limit), t.startAt && (e$1 += "|lb:", e$1 += t.startAt.inclusive ? "b:" : "a:", e$1 += t.startAt.position.map(((e$2) => canonicalId(e$2))).join(",")), t.endAt && (e$1 += "|ub:", e$1 += t.endAt.inclusive ? "a:" : "b:", e$1 += t.endAt.position.map(((e$2) => canonicalId(e$2))).join(",")), t.Pe = e$1;
	}
	return t.Pe;
}
...
*/ function __PRIVATE_queryNormalizedOrderBy(e) {
	...
	if (null === t.Te) {
		...
		for (const n$1 of t.explicitOrderBy) t.Te.push(n$1), e$1.add(n$1.field.canonicalString());
		...
		(function __PRIVATE_getInequalityFilterFields(e$2) {
			...
			e$1.has(r.canonicalString()) || r.isKeyField() || t.Te.push(new OrderBy(r, n));
		})), e$1.has(FieldPath$1.keyField().canonicalString()) || t.Te.push(new OrderBy(FieldPath$1.keyField(), n));
	}
	return t.Te;
}
/**
...
*/ function __PRIVATE_applyTransformOperationToLocalView(e, t, n) {
	return e instanceof __PRIVATE_ServerTimestampTransform ? function serverTimestamp$1(e$1, t$1) {
		...
		return t$1 && __PRIVATE_isServerTimestamp(t$1) && (t$1 = __PRIVATE_getPreviousValue(t$1)), t$1 && (n$1.fields[_t] = t$1), { mapValue: n$1 };
		...
		const n$1 = __PRIVATE_computeTransformOperationBaseValue(e$1, t$1), r = asNumber(n$1) + asNumber(e$1.Ee);
		return isInteger(n$1) && isInteger(e$1.Ee) ? __PRIVATE_toInteger(r) : __PRIVATE_toDouble(e$1.serializer, r);
	}(e, t);
}
/**
...
var BloomFilter = class BloomFilter {
	constructor(e, t, n) {
		...
		this.fe = 8 * e.length - t, this.ge = Integer.fromNumber(this.fe);
	}
	pe(e, t, n) {
...
/** Tracks the internal state of a Watch target. */ var __PRIVATE_TargetState = class {
	constructor() {
		...
		*/
		this.ve = 0, this.Ce = __PRIVATE_snapshotChangesMap(), this.Fe = ByteString.EMPTY_BYTE_STRING, this.Me = !1, this.xe = !0;
	}
	/**
...
var __PRIVATE_WatchChangeAggregator = class {
	constructor(e) {
		this.We = e, this.Ge = /* @__PURE__ */ new Map(), this.ze = __PRIVATE_mutableDocumentMap(), this.je = __PRIVATE_documentTargetMap(), this.Je = __PRIVATE_documentTargetMap(), this.He = new SortedMap(__PRIVATE_primitiveComparator);
	}
	/**
		...
		this.forEachTarget(e, ((t) => {
			...
			switch (e.state) {
				case 0:
					...
					break;
				case 1:
					n.Ue(), n.Oe || n.ke(), n.Be(e.resumeToken);
					break;
				case 2:
				...
				case 3:
					...
					break;
				case 4:
					this.nt(t) && (this.rt(t), n.Be(e.resumeToken));
					break;
	...
	* active targets.
	*/ forEachTarget(e, t) {
		e.targetIds.length > 0 ? e.targetIds.forEach(t) : this.Ge.forEach(((e$1, n) => {
			this.nt(n) && t(n);
		}));
	}
	/**
	...
	*/ it(e) {
		...
		if (r) {
			...
			if (__PRIVATE_targetIsDocumentTarget(i)) if (0 === n) {
				...
				this.Xe(t, e$1, MutableDocument.newNoDocument(e$1, SnapshotVersion.min()));
			} else __PRIVATE_hardAssert(1 === n, 20013, { expectedCount: n });
			else {
				const r$1 = this.ot(t);
				if (r$1 !== n) {
					const n$1 = this._t(e), i$1 = n$1 ? this.ut(n$1, e, r$1) : 1;
					if (0 !== i$1) {
						this.rt(t);
						const e$1 = 2 === i$1 ? "TargetPurposeExistenceFilterMismatchBloom" : "TargetPurposeExistenceFilterMismatch";
						this.He = this.He.insert(t, e$1);
					}
					pt?.ct(function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e$1, t$1, n$2, r$2, i$2) {
						var s, o, _, a, u, c;
						const l = {
							localCacheCount: e$1,
						...
						h && (l.bloomFilter = {
							...
							mightContain: (e$2) => {
								var t$2;
								return null !== (t$2 = null == r$2 ? void 0 : r$2.mightContain(e$2)) && void 0 !== t$2 && t$2;
							}
						});
						return l;
					}(r$1, e.De, this.We.lt(), n$1, i$1));
				}
			}
		}
	}
	...
	*/ ht(e, t) {
		...
		return n.forEach(((n$1) => {
			const i = this.We.lt(), s = `projects/${i.projectId}/databases/${i.database}/documents/${n$1.path.canonicalString()}`;
			e.mightContain(s) || (this.Xe(t, n$1, null), r++);
		})), r;
	}
	/**
	...
	*/ Pt(e) {
		const t = /* @__PURE__ */ new Map();
		this.Ge.forEach(((n$1, r$1) => {
			const i = this.st(r$1);
			if (i) {
				if (n$1.current && __PRIVATE_targetIsDocumentTarget(i.target)) {
					const t$1 = new DocumentKey(i.target.path);
					this.Tt(t$1).has(r$1) || this.It(r$1, t$1) || this.Xe(r$1, t$1, MutableDocument.newNoDocument(t$1, e));
				}
				n$1.Ne && (t.set(r$1, n$1.Le()), n$1.ke());
			}
		}));
		...
		this.Je.forEach(((e$1, t$1) => {
			...
			t$1.forEachWhile(((e$2) => {
				const t$2 = this.st(e$2);
				return !t$2 || "TargetPurposeLimboResolution" === t$2.purpose || (r$1 = !1, !1);
			})), r$1 && (n = n.add(e$1));
		})), this.ze.forEach(((t$1, n$1) => n$1.setReadTime(e)));
	...
	*/
	Xe(e, t, n) {
		if (!this.nt(e)) return;
		const r = this.tt(e);
		this.It(e, t) ? r.qe(t, 1) : r.Qe(t), this.Je = this.Je.insert(t, this.dt(t).delete(e)), this.Je = this.Je.insert(t, this.dt(t).add(e)), n && (this.ze = this.ze.insert(t, n));
	}
	removeTarget(e) {
		this.Ge.delete(e);
	}
...
function __PRIVATE_fromWatchChange(e, t) {
	...
	if ("targetChange" in t) {
		...
		n = new __PRIVATE_WatchTargetChange(r, i, s, o && function __PRIVATE_fromRpcStatus(e$1) {
			return new FirestoreError(void 0 === e$1.code ? N.UNKNOWN : __PRIVATE_mapCodeFromRpcCode(e$1.code), e$1.message || "");
		}(o) || null);
...
function toMutation(e, t) {
	...
	if (t instanceof __PRIVATE_SetMutation) n = { update: __PRIVATE_toMutationDocument(e, t.key, t.value) };
		...
		if (!(t instanceof __PRIVATE_VerifyMutation)) return fail(16599, { Rt: t.type });
...
function __PRIVATE_fromMutation(e, t) {
	const n = t.currentDocument ? function __PRIVATE_fromPrecondition(e$1) {
		...
		else if ("appendMissingElements" in t$2) n$1 = new __PRIVATE_ArrayUnionTransformOperation(t$2.appendMissingElements.values || []);
		else if ("removeAllFromArray" in t$2) n$1 = new __PRIVATE_ArrayRemoveTransformOperation(t$2.removeAllFromArray.values || []);
		else "increment" in t$2 ? n$1 = new __PRIVATE_NumericIncrementTransformOperation(e$1, t$2.increment) : fail(16584, { proto: t$2 });
		return new FieldTransform(FieldPath$1.fromServerFormat(t$2.fieldPath), n$1);
	}(e, t$1))) : [];
	if (t.update) {
		t.update.name;
		const i = fromName(e, t.update.name), s = new ObjectValue({ mapValue: { fields: t.update.fields } });
		if (t.updateMask) return new __PRIVATE_PatchMutation(i, s, function __PRIVATE_fromDocumentMask(e$1) {
			return new FieldMask((e$1.fieldPaths || []).map(((e$2) => FieldPath$1.fromServerFormat(e$2))));
		}(t.updateMask), n, r);
...
function __PRIVATE_convertQueryTargetToQuery(e) {
	...
	n.startAt && (a = function __PRIVATE_fromStartAtCursor(e$1) {
		const t$1 = !!e$1.before;
		return new Bound(e$1.values || [], t$1);
	}(n.startAt));
	let u = null;
...
function __PRIVATE_fromDbMutationBatch(e, t) {
	const n = (t.baseMutations || []).map(((t$1) => __PRIVATE_fromMutation(e.gt, t$1)));
	...
	const r = t.mutations.map(((t$1) => __PRIVATE_fromMutation(e.gt, t$1))), i = Timestamp.fromMillis(t.localWriteTimeMs);
	...
	*/
	...
	removeOverlaysForBatchId(e, t, n) {
		...
		return r.forEach(((t$1) => {
			...
			i.push(__PRIVATE_documentOverlayStore(e).Y(Ke, r$1));
	...
	getOverlaysForCollection(e, t, n) {
		...
		return __PRIVATE_documentOverlayStore(e).j(Ke, s).next(((e$1) => {
	...
	wt(e, t) {
		return __PRIVATE_documentOverlayStore(e).put(function __PRIVATE_toDbDocumentOverlay(e$1, t$1, n) {
			...
			return {
				...
				overlayMutation: toMutation(e$1.gt, n.mutation)
			};
...
*/ var __PRIVATE_IndexedDbGlobalsCache = class {
	...
	getSessionToken(e) {
		return this.St(e).get("sessionToken").next(((e$1) => {
			const t = null == e$1 ? void 0 : e$1.value;
...
var __PRIVATE_FirestoreIndexValueWriter = class {
	...
	kt(e, t) {
		const n = e.fields || {};
		this.Ct(t, 55);
		for (const e$1 of Object.keys(n)) this.xt(e$1, t), this.Dt(n[e$1], t);
	}
	Lt(e, t) {
		var n, r;
		const i = e.fields || {};
	...
	qt(e, t) {
		const n = e.values || [];
		this.Ct(t, 50);
		for (const e$1 of n) this.Dt(e$1, t);
	}
	Bt(e, t) {
		this.Ct(t, 37);
		DocumentKey.fromName(e).path.forEach(((e$1) => {
			this.Ct(t, 60), this.$t(e$1, t);
		}));
	}
	Ct(e, t) {
		e.Ft(t);
...
*/ var __PRIVATE_OrderedCodeWriter = class {
	...
	/** Writes utf8 bytes into this byte sequence, ascending. */ Ht(e) {
		for (const t of e) {
			...
			if (e$1 < 128) this.Wt(e$1);
			else if (e$1 < 2048) this.Wt(960 | e$1 >>> 6), this.Wt(128 | 63 & e$1);
			else if (t < "\ud800" || "\udbff" < t) this.Wt(480 | e$1 >>> 12), this.Wt(128 | 63 & e$1 >>> 6), this.Wt(128 | 63 & e$1);
			else {
				const e$2 = t.codePointAt(0);
				this.Wt(240 | e$2 >>> 18), this.Wt(128 | 63 & e$2 >>> 12), this.Wt(128 | 63 & e$2 >>> 6), this.Wt(128 | 63 & e$2);
			}
		}
		this.Gt();
	}
...
/** Represents an index entry saved by the SDK in persisted storage. */ var __PRIVATE_IndexEntry = class __PRIVATE_IndexEntry {
	...
	*/ En() {
		...
		return n.set(this.dn, 0), t !== e ? n.set([0], this.dn.length) : ++n[n.length - 1], new __PRIVATE_IndexEntry(this.Pn, this.Tn, this.In, n);
	}
	An(e, t, n) {
		return {
			indexId: this.Pn,
...
var __PRIVATE_TargetIndexMatcher = class {
	constructor(e) {
		this.Vn = new SortedSet(((e$1, t) => FieldPath$1.comparator(e$1.field, t.field))), this.collectionId = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment(), this.mn = e.orderBy, this.fn = [];
		for (const t of e.filters) {
			const e$1 = t;
			e$1.isInequality() ? this.Vn = this.Vn.add(e$1) : this.fn.push(e$1);
		}
	}
	get gn() {
	...
	*   omitted.
	*/ pn(e) {
		if (__PRIVATE_hardAssert(e.collectionGroup === this.collectionId, 49279), this.gn) return !1;
		...
		if (this.Vn.size > 0) {
			...
			if (!r.has(e$1.field.canonicalString())) {
				const t$1 = n[i];
				if (!this.wn(e$1, t$1) || !this.Sn(this.mn[s++], t$1)) return !1;
			}
			++i;
		}
		for (; i < n.length; ++i) {
			const e$1 = n[i];
			if (s >= this.mn.length || !this.Sn(this.mn[s++], e$1)) return !1;
		}
		return !0;
	}
	/**
	...
	*/ bn() {
		...
		for (const n of this.mn) n.field.isKeyField() || e.has(n.field) || (e = e.add(n.field), t.push(new IndexSegment(n.field, "asc" === n.dir ? 0 : 1)));
...
*/ function __PRIVATE_computeInExpansion(e) {
	...
	if (__PRIVATE_hardAssert(e instanceof FieldFilter || e instanceof CompositeFilter, 20012), e instanceof FieldFilter) {
		if (e instanceof __PRIVATE_InFilter) {
			const r$1 = (null === (n = null === (t = e.value.arrayValue) || void 0 === t ? void 0 : t.values) || void 0 === n ? void 0 : n.map(((t$1) => FieldFilter.create(e.field, "==", t$1)))) || [];
			return CompositeFilter.create(r$1, "or");
		}
		return e;
	}
	const r = e.filters.map(((e$1) => __PRIVATE_computeInExpansion(e$1)));
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var vt = "IndexedDbIndexManager", Ct = new Uint8Array(0);
/**
...
var __PRIVATE_IndexedDbIndexManager = class {
	constructor(e, t) {
		this.databaseId = t, this.vn = new __PRIVATE_MemoryCollectionParentIndex(), this.Cn = new ObjectMap(((e$1) => __PRIVATE_canonifyTarget(e$1)), ((e$1, t$1) => __PRIVATE_targetEquals(e$1, t$1))), this.uid = e.uid || "";
	}
	/**
	...
	*/ addToCollectionParentIndex(e, t) {
	...
	createTargetIndexes(e, t) {
		return PersistencePromise.forEach(this.Fn(t), ((t$1) => this.getIndexType(e, t$1).next(((n) => {
			if (0 === n || 1 === n) {
	...
	getDocumentsMatchingTarget(e, t) {
		...
		return PersistencePromise.forEach(this.Fn(t), ((t$1) => this.Mn(e, t$1).next(((e$1) => {
			...
			if (r) {
				...
				return PersistencePromise.forEach(i, ((i$1, s) => {
					__PRIVATE_logDebug(vt, `Using index ${function __PRIVATE_fieldIndexToString(e$2) {
					...
					const o = function __PRIVATE_targetGetArrayValues(e$2, t$1) {
						...
						return new Bound(n$1, r$2);
					}(s, i$1), c = this.xn(i$1, s, a), l = this.xn(i$1, s, u), h = this.On(i$1, s, _), P = this.Nn(i$1.indexId, o, c, a.inclusive, l, u.inclusive, h);
					return PersistencePromise.forEach(P, ((i$2) => n.H(i$2, t.limit).next(((t$1) => {
						t$1.forEach(((t$2) => {
	...
	*/ Nn(e, t, n, r, i, s, o) {
		...
		for (let c = 0; c < _; ++c) {
			const _$1 = t ? this.Bn(t[c / a]) : Ct, l = this.Ln(e, _$1, n[c % a], r), h = this.kn(e, _$1, i[c % a], s), P = o.map(((t$1) => this.Ln(e, _$1, t$1, !0)));
	...
	Mn(e, t) {
		...
		return this.getFieldIndexes(e, r).next(((e$1) => {
			let t$1 = null;
			for (const r$1 of e$1) n.pn(r$1) && (!t$1 || r$1.fields.length > t$1.fields.length) && (t$1 = r$1);
			return t$1;
		}));
	}
	getIndexType(e, t) {
		let n = 2;
		const r = this.Fn(t);
		return PersistencePromise.forEach(r, ((t$1) => this.Mn(e, t$1).next(((e$1) => {
	...
	*/ qn(e, t) {
		...
		for (const r of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
			...
			const i = n.hn(r.kind);
			__PRIVATE_FirestoreIndexValueWriter.Ut.bt(e$1, i);
		}
		return n.an();
	}
	/** Encodes a single value to the ascending index format. */ Bn(e) {
		const t = new __PRIVATE_IndexByteEncoder();
		return __PRIVATE_FirestoreIndexValueWriter.Ut.bt(e, t.hn(0)), t.an();
	}
	/**
	...
	*/ Qn(e, t) {
		const n = new __PRIVATE_IndexByteEncoder();
		return __PRIVATE_FirestoreIndexValueWriter.Ut.bt(__PRIVATE_refValue(this.databaseId, t), n.hn(function __PRIVATE_fieldIndexGetKeyOrder(e$1) {
	...
	*/ On(e, t, n) {
		...
		for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
			const e$1 = n[i++];
			for (const n$1 of r) if (this.$n(t, s.fieldPath) && isArray(e$1)) r = this.Un(r, s, e$1);
			else {
				const t$1 = n$1.hn(s.kind);
				__PRIVATE_FirestoreIndexValueWriter.Ut.bt(e$1, t$1);
			}
		}
		return this.Kn(r);
	}
	...
	*/ Un(e, t, n) {
		...
		for (const e$1 of n.arrayValue.values || []) for (const n$1 of r) {
			...
			r$1.seed(n$1.an()), __PRIVATE_FirestoreIndexValueWriter.Ut.bt(e$1, r$1.hn(t.kind)), i.push(r$1);
		}
		return i;
	}
	$n(e, t) {
	...
	getFieldIndexes(e, t) {
		...
		return (t ? n.j(Fe, IDBKeyRange.bound(t, t)) : n.j()).next(((e$1) => {
			const t$1 = [];
	...
	updateCollectionGroup(e, t, n) {
		...
		return this.Wn(e).next(((e$1) => r.j(Fe, IDBKeyRange.bound(t, t)).next(((t$1) => PersistencePromise.forEach(t$1, ((t$2) => i.put(__PRIVATE_toDbIndexState(t$2.indexId, this.uid, e$1, n))))))));
	}
	updateIndexEntries(e, t) {
		const n = /* @__PURE__ */ new Map();
		return PersistencePromise.forEach(t, ((t$1, r) => {
			const i = n.get(t$1.collectionGroup);
			return (i ? PersistencePromise.resolve(i) : this.getFieldIndexes(e, t$1.collectionGroup)).next(((i$1) => (n.set(t$1.collectionGroup, i$1), PersistencePromise.forEach(i$1, ((n$1) => this.Gn(e, t$1, n$1).next(((t$2) => {
				const i$2 = this.zn(r, n$1);
	...
	/** Creates the index entries for the given document. */ zn(e, t) {
		...
		if (null != i) {
			...
			if (isArray(s)) for (const i$1 of s.arrayValue.values || []) n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.Bn(i$1), r));
	...
	*/ createRange(e, t, n) {
		...
		for (let e$1 = 0; e$1 < r.length; e$1 += 2) {
			if (this.Yn(r[e$1], r[e$1 + 1])) return [];
			const t$1 = r[e$1].Rn(this.uid, Ct, DocumentKey.empty()), n$1 = r[e$1 + 1].Rn(this.uid, Ct, DocumentKey.empty());
	...
	getMinOffset(e, t) {
		return PersistencePromise.mapArray(this.Fn(t), ((t$1) => this.Mn(e, t$1).next(((e$1) => e$1 || fail(44426))))).next(__PRIVATE_getMinOffsetFromFieldIndexes);
	}
};
/**
...
function removeMutationBatch(e, t, n) {
	...
	let _ = 0;
	const a = r.X({ range: o }, ((e$1, t$1, n$1) => (_++, n$1.delete())));
	s.push(a.next((() => {
	...
	addMutationBatch(e, t, n, r) {
		...
		return s.add({}).next(((o) => {
			...
			const _ = new MutationBatch(o, t, n, r), a = function __PRIVATE_toDbMutationBatch(e$1, t$1, n$1) {
				const r$1 = n$1.baseMutations.map(((t$2) => toMutation(e$1.gt, t$2))), i$1 = n$1.mutations.map(((t$2) => toMutation(e$1.gt, t$2)));
				return {
					userId: t$1,
					batchId: n$1.batchId,
			...
			for (const e$1 of r) {
				...
				c = c.add(e$1.key.path.popLast()), u.push(s.put(a)), u.push(i.put(t$1, re));
			}
	...
	*/
	...
	getNextMutationBatchAfterBatchId(e, t) {
		...
		return __PRIVATE_mutationsStore(e).X({
			...
			t$1.userId === this.userId && (__PRIVATE_hardAssert(t$1.batchId >= n, 47524, { er: n }), i = __PRIVATE_fromDbMutationBatch(this.serializer, t$1)), r$1.done();
		})).next((() => i));
	}
	...
	getAllMutationBatches(e) {
		...
		return __PRIVATE_mutationsStore(e).j(te, t).next(((e$1) => e$1.map(((e$2) => __PRIVATE_fromDbMutationBatch(this.serializer, e$2)))));
	}
	getAllMutationBatchesAffectingDocumentKey(e, t) {
		const n = __PRIVATE_newDbDocumentMutationPrefixForPath(this.userId, t.path), r = IDBKeyRange.lowerBound(n), i = [];
		return __PRIVATE_documentMutationsStore(e).X({ range: r }, ((n$1, r$1, s) => {
	...
	getAllMutationBatchesAffectingDocumentKeys(e, t) {
		...
		return t.forEach(((t$1) => {
			const i = __PRIVATE_newDbDocumentMutationPrefixForPath(this.userId, t$1.path), s = IDBKeyRange.lowerBound(i), o = __PRIVATE_documentMutationsStore(e).X({ range: s }, ((e$1, r$1, i$1) => {
	...
	getAllMutationBatchesAffectingQuery(e, t) {
		...
		return __PRIVATE_documentMutationsStore(e).X({ range: s }, ((e$1, t$1, i$1) => {
	...
	*/
	...
	performConsistencyCheck(e) {
		return this.checkEmpty(e).next(((t) => {
			...
			return __PRIVATE_documentMutationsStore(e).X({ range: n }, ((e$1, t$1, n$1) => {
				if (e$1[0] === this.userId) {
					const t$2 = __PRIVATE_decodeResourcePath(e$1[1]);
					r.push(t$2);
				} else n$1.done();
			})).next((() => {
				__PRIVATE_hardAssert(0 === r.length, 56720, { ir: r.map(((e$1) => e$1.canonicalString())) });
			}));
		}));
	}
	containsKey(e, t) {
...
*/ var __PRIVATE_IndexedDbTargetCache = class {
	...
	allocateTargetId(e) {
		return this.cr(e).next(((t) => {
			return t.highestTargetId = new __PRIVATE_TargetIdGenerator(t.highestTargetId).next(), this.lr(e, t).next((() => t.highestTargetId));
		}));
	}
	getLastRemoteSnapshotVersion(e) {
		return this.cr(e).next(((e$1) => SnapshotVersion.fromTimestamp(new Timestamp(e$1.lastRemoteSnapshotVersion.seconds, e$1.lastRemoteSnapshotVersion.nanoseconds))));
	}
	getHighestSequenceNumber(e) {
		return this.cr(e).next(((e$1) => e$1.highestListenSequenceNumber));
	}
	...
	removeTargetData(e, t) {
		return this.removeMatchingKeysForTargetId(e, t.targetId).next((() => __PRIVATE_targetsStore(e).delete(t.targetId))).next((() => this.cr(e))).next(((t$1) => (__PRIVATE_hardAssert(t$1.targetCount > 0, 8065), t$1.targetCount -= 1, this.lr(e, t$1))));
	}
	/**
	...
	*/ forEachTarget(e, t) {
		return __PRIVATE_targetsStore(e).X(((e$1, n) => {
			t(__PRIVATE_fromDbTarget(n));
		}));
	}
	cr(e) {
		return __PRIVATE_globalTargetStore(e).get(Ve).next(((e$1) => (__PRIVATE_hardAssert(null !== e$1, 2888), e$1)));
	}
	lr(e, t) {
	...
	*/ Pr(e, t) {
	...
	getTargetCount(e) {
		return this.cr(e).next(((e$1) => e$1.targetCount));
	}
	getTargetData(e, t) {
	...
	getMatchingKeysForTargetId(e, t) {
		...
		return r.X({
			...
			const s = new DocumentKey(__PRIVATE_decodeResourcePath(e$1[1]));
			i = i.add(s);
		})).next((() => i));
	}
	containsKey(e, t) {
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var xt = "LruGarbageCollector", Ot = 1048576;
	...
	Rr(e) {
		__PRIVATE_logDebug(xt, `Garbage collection scheduled in ${e}ms`), this.Ar = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, (async () => {
			...
			try {
				...
				__PRIVATE_isIndexedDbTransactionError(e$1) ? __PRIVATE_logDebug(xt, "Ignoring IndexedDB error during garbage collection: ", e$1) : await __PRIVATE_ignoreIfPrimaryLeaseLoss(e$1);
			}
			await this.Rr(3e5);
		}));
	}
...
*/ var __PRIVATE_LruGarbageCollectorImpl = class {
	...
	calculateTargetCount(e, t) {
		return this.Vr.mr(e).next(((e$1) => Math.floor(t / 100 * e$1)));
	}
	nthSequenceNumber(e, t) {
		...
		return this.Vr.forEachTarget(e, ((e$1) => n.Er(e$1.sequenceNumber))).next((() => this.Vr.gr(e, ((e$1) => n.Er(e$1))))).next((() => n.maxValue));
	}
	removeTargets(e, t, n) {
...
/** Provides LRU functionality for IndexedDB persistence. */ var __PRIVATE_IndexedDbLruDelegateImpl = class {
	...
	*/ Sr(e, t) {
		return function __PRIVATE_mutationQueuesContainKey(e$1, t$1) {
			let n = !1;
			return __PRIVATE_mutationQueuesStore(e$1).ee(((r) => __PRIVATE_mutationQueueContainsKey(e$1, r, t$1).next(((e$2) => (e$2 && (n = !0), PersistencePromise.resolve(!e$2)))))).next((() => n));
		}(e, t);
	}
	removeOrphanedDocuments(e, t) {
		...
		return this.wr(e, ((s, o) => {
			if (o <= t) {
				const t$1 = this.Sr(e, s).next(((t$2) => {
	...
	*/ wr(e, t) {
		...
		return n.X({ index: Ae }, (([e$1, n$1], { path: s, sequenceNumber: o }) => {
			0 === e$1 ? (i !== __PRIVATE_ListenSequence.ue && t(new DocumentKey(__PRIVATE_decodeResourcePath(r)), i), i = o, r = s) : i = __PRIVATE_ListenSequence.ue;
		})).next((() => {
	...
	*/ Fr(e, t) {
	...
	Cr(e, t, n) {
		...
		return __PRIVATE_remoteDocumentsStore(e).X({
			...
			o && o.isEqual(i$1) && (n(o, t$1), o = s.hasNext() ? s.getNext() : null), o ? r$1.G(__PRIVATE_dbKey(o)) : r$1.done();
		})).next((() => {
	...
	getDocumentsMatchingQuery(e, t, n, r, i) {
		...
		return __PRIVATE_remoteDocumentsStore(e).j(IDBKeyRange.bound(o, _, !0)).next(((e$1) => {
			...
			for (const i$1 of e$1) {
				const e$2 = this.Dr(DocumentKey.fromSegments(i$1.prefixPath.concat(i$1.collectionGroup, i$1.documentId)), i$1);
	...
	getAllFromCollectionGroup(e, t, n, r) {
		...
		return __PRIVATE_remoteDocumentsStore(e).X({
			...
			const s$1 = this.Dr(DocumentKey.fromSegments(t$1.prefixPath.concat(t$1.collectionGroup, t$1.documentId)), t$1);
	...
	getMetadata(e) {
		return __PRIVATE_documentGlobalStore(e).get(he).next(((e$1) => (__PRIVATE_hardAssert(!!e$1, 20021), e$1)));
	}
	br(e, t) {
...
*/ var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
	...
	*/
	constructor(e, t) {
		super(), this.Or = e, this.trackRemovals = t, this.Nr = new ObjectMap(((e$1) => e$1.toString()), ((e$1, t$1) => e$1.isEqual(t$1)));
	}
	applyChanges(e) {
		const t = [];
		...
		return this.changes.forEach(((i, s) => {
			...
			if (t.push(this.Or.removeEntry(e, i, o.readTime)), s.isValidDocument()) {
				...
				const n$1 = __PRIVATE_toDbRemoteDocument(this.Or.serializer, s.convertToNoDocument(SnapshotVersion.min()));
				t.push(this.Or.addEntry(e, i, n$1));
			}
		})), r.forEach(((n$1) => {
			t.push(this.Or.indexManager.addToCollectionParentIndex(e, n$1));
		})), t.push(this.Or.updateMetadata(e, n)), PersistencePromise.waitFor(t);
	}
	getFromCache(e, t) {
		return this.Or.vr(e, t).next(((e$1) => (this.Nr.set(t, {
			size: e$1.size,
			readTime: e$1.document.readTime
		}), e$1.document)));
	}
	getAllFromCache(e, t) {
		return this.Or.Fr(e, t).next((({ documents: e$1, Mr: t$1 }) => (t$1.forEach(((t$2, n) => {
			this.Nr.set(t$2, {
				size: n,
...
*/ var LocalDocumentsView = class {
	...
	*/ computeViews(e, t, n, r) {
		...
		})), this.recalculateAndSaveOverlays(e, i).next(((e$1) => (e$1.forEach(((e$2, t$1) => s.set(e$2, t$1))), t.forEach(((e$2, t$1) => {
			var n$1;
			return o.set(e$2, new OverlayedDocument(t$1, null !== (n$1 = s.get(e$2)) && void 0 !== n$1 ? n$1 : null));
		})), o)));
	}
...
*/ var __PRIVATE_MemoryBundleCache = class {
	...
	saveNamedQuery(e, t) {
		return this.Lr.set(t.name, function __PRIVATE_fromProtoNamedQuery(e$1) {
			return {
				name: e$1.name,
...
*/ var __PRIVATE_MemoryDocumentOverlayCache = class {
	...
	removeOverlaysForBatchId(e, t, n) {
		...
		return void 0 !== r && (r.forEach(((e$1) => this.overlays = this.overlays.remove(e$1))), this.kr.delete(n)), PersistencePromise.resolve();
	}
	getOverlaysForCollection(e, t, n) {
	...
	wt(e, t, n) {
		...
		if (null !== r) {
			const e$1 = this.kr.get(r.largestBatchId).delete(n.key);
			this.kr.set(r.largestBatchId, e$1);
		}
...
*/ var __PRIVATE_ReferenceSet = class {
	...
	*/ zr(e) {
		...
		return this.$r.forEachInRange([n, r], ((e$1) => {
...
*/ var __PRIVATE_MemoryMutationQueue = class {
	...
	addMutationBatch(e, t, n, r) {
		...
		for (const t$1 of r) this.Yr = this.Yr.add(new __PRIVATE_DocReference(t$1.key, i)), this.indexManager.addToCollectionParentIndex(e, t$1.key.path.popLast());
	...
	getAllMutationBatchesAffectingDocumentKey(e, t) {
		...
		return this.Yr.forEachInRange([n, r], ((e$1) => {
	...
	getAllMutationBatchesAffectingDocumentKeys(e, t) {
		...
		return t.forEach(((e$1) => {
			...
			this.Yr.forEachInRange([t$1, r], ((e$2) => {
				n = n.add(e$2.Hr);
			}));
	...
	getAllMutationBatchesAffectingQuery(e, t) {
		...
		let o = new SortedSet(__PRIVATE_primitiveComparator);
		return this.Yr.forEachWhile(((e$1) => {
...
*/ var __PRIVATE_MemoryTargetCache = class {
	constructor(e) {
		this.persistence = e, this.ii = new ObjectMap(((e$1) => __PRIVATE_canonifyTarget(e$1)), __PRIVATE_targetEquals), this.lastRemoteSnapshotVersion = SnapshotVersion.min(), this.highestTargetId = 0, this.si = 0, this.oi = new __PRIVATE_ReferenceSet(), this.targetCount = 0, this._i = __PRIVATE_TargetIdGenerator.ar();
	}
	forEachTarget(e, t) {
		return this.ii.forEach(((e$1, n) => t(n))), PersistencePromise.resolve();
	}
	getLastRemoteSnapshotVersion(e) {
...
var __PRIVATE_MemoryPersistence = class {
	...
	*/
	constructor(e, t) {
		...
		}(((e$1) => this.referenceDelegate.Pi(e$1))), this.serializer = new __PRIVATE_LocalSerializer(t), this.Ti = new __PRIVATE_MemoryBundleCache(this.serializer);
	}
	start() {
	...
	runTransaction(e, t, n) {
		...
		return this.referenceDelegate.Ii(), n(r).next(((e$1) => this.referenceDelegate.di(r).next((() => e$1)))).toPromise().then(((e$1) => (r.raiseOnCommittedEvent(), e$1)));
	}
	Ei(e, t) {
...
var __PRIVATE_MemoryEagerDelegate = class __PRIVATE_MemoryEagerDelegate {
	...
	removeTarget(e, t) {
		this.Ai.zr(t.targetId).forEach(((e$1) => this.mi.add(e$1.toString())));
		const n = this.persistence.getTargetCache();
		return n.getMatchingKeysForTargetId(e, t.targetId).next(((e$1) => {
			e$1.forEach(((e$2) => this.mi.add(e$2.toString())));
	...
	di(e) {
		...
		return PersistencePromise.forEach(this.mi, ((n) => {
			...
			return this.fi(e, r).next(((e$1) => {
				e$1 || t.removeEntry(r, SnapshotVersion.min());
			}));
		})).next((() => (this.Ri = null, t.apply(e))));
	}
	updateLimboDocument(e, t) {
		return this.fi(e, t).next(((e$1) => {
			e$1 ? this.mi.delete(t.toString()) : this.mi.add(t.toString());
		}));
	}
	Pi(e) {
		return 0;
...
var __PRIVATE_MemoryLruDelegate = class __PRIVATE_MemoryLruDelegate {
	constructor(e, t) {
		this.persistence = e, this.gi = new ObjectMap(((e$1) => __PRIVATE_encodeResourcePath(e$1.path)), ((e$1, t$1) => e$1.isEqual(t$1))), this.garbageCollector = __PRIVATE_newLruGarbageCollector(this, t);
	}
	static Vi(e, t) {
	...
	gr(e, t) {
		return PersistencePromise.forEach(this.gi, ((n, r) => this.Sr(e, n, r).next(((e$1) => e$1 ? PersistencePromise.resolve() : t(r)))));
	}
	removeTargets(e, t, n) {
	...
	removeOrphanedDocuments(e, t) {
		...
		return r.ri(e, ((r$1) => this.Sr(e, r$1, t).next(((e$1) => {
...
/** Performs database creation and schema upgrades. */ var __PRIVATE_SchemaConverter = class {
	...
	*/ q(e, t, n, r) {
		...
		n < 1 && r >= 1 && (function __PRIVATE_createPrimaryClientStore(e$1) {
			e$1.createObjectStore(J);
		}(e), function __PRIVATE_createMutationQueue(e$1) {
			e$1.createObjectStore(Y, { keyPath: Z });
			e$1.createObjectStore(X, {
				keyPath: ee,
				autoIncrement: !0
			}).createIndex(te, ne, { unique: !0 }), e$1.createObjectStore(ie);
		...
		return n < 3 && r >= 3 && (0 !== n && (function __PRIVATE_dropQueryCache(e$1) {
			e$1.deleteObjectStore(de), e$1.deleteObjectStore(Pe), e$1.deleteObjectStore(me);
		}(e), __PRIVATE_createQueryCache(e)), s = s.next((() => function __PRIVATE_writeEmptyTargetGlobalEntry(e$1) {
			const t$1 = e$1.store(me), n$1 = {
				highestTargetId: 0,
				highestListenSequenceNumber: 0,
				lastRemoteSnapshotVersion: SnapshotVersion.min().toTimestamp(),
				targetCount: 0
			};
			return t$1.put(Ve, n$1);
		}(i)))), n < 4 && r >= 4 && (0 !== n && (s = s.next((() => function __PRIVATE_upgradeMutationBatchSchemaAndMigrateData(e$1, t$1) {
			return t$1.store(X).j().next(((n$1) => {
				e$1.deleteObjectStore(X);
				e$1.createObjectStore(X, {
					keyPath: ee,
					autoIncrement: !0
				}).createIndex(te, ne, { unique: !0 });
				const r$1 = t$1.store(X), i$1 = n$1.map(((e$2) => r$1.put(e$2)));
		...
		}))), n < 5 && r >= 5 && (s = s.next((() => this.pi(i)))), n < 6 && r >= 6 && (s = s.next((() => (function __PRIVATE_createDocumentGlobalStore(e$1) {
			e$1.createObjectStore(le);
			...
			(function __PRIVATE_createDocumentOverlayStore(e$1) {
				const t$1 = e$1.createObjectStore($e, { keyPath: Ue });
				t$1.createIndex(Ke, We, { unique: !1 }), t$1.createIndex(Ge, ze, { unique: !1 });
			})(e);
		}))), n < 13 && r >= 13 && (s = s.next((() => function __PRIVATE_createRemoteDocumentCache(e$1) {
			const t$1 = e$1.createObjectStore(se, { keyPath: oe });
			t$1.createIndex(_e, ae), t$1.createIndex(ue, ce);
		}(e))).next((() => this.Di(e, i))).next((() => e.deleteObjectStore(j)))), n < 14 && r >= 14 && (s = s.next((() => this.Ci(e, i)))), n < 15 && r >= 15 && (s = s.next((() => function __PRIVATE_createFieldIndex(e$1) {
			e$1.createObjectStore(ve, {
				keyPath: Ce,
				autoIncrement: !0
			}).createIndex(Fe, Me, { unique: !1 });
			e$1.createObjectStore(xe, { keyPath: Oe }).createIndex(Ne, Be, { unique: !1 });
			e$1.createObjectStore(Le, { keyPath: ke }).createIndex(qe, Qe, { unique: !1 });
			...
			(function __PRIVATE_createGlobalsStore(e$1) {
				e$1.createObjectStore(je, { keyPath: Je });
			})(e);
	...
	pi(e) {
		...
		return t.j().next(((t$1) => PersistencePromise.forEach(t$1, ((t$2) => {
			const r = IDBKeyRange.bound([t$2.userId, G], [t$2.userId, t$2.lastAcknowledgedBatchId]);
			return n.j(te, r).next(((n$1) => PersistencePromise.forEach(n$1, ((n$2) => {
	...
	*/ wi(e) {
		...
		return e.store(me).get(Ve).next(((e$1) => {
			const r = [];
			return n.X(((n$1, i) => {
	...
	Si(e, t) {
		...
		const n = t.store(fe), r = new __PRIVATE_MemoryCollectionParentIndex(), addEntry = (e$1) => {
			if (r.add(e$1)) {
		...
		return t.store(j).X({ Z: !0 }, ((e$1, t$1) => {
			return addEntry(new ResourcePath(e$1).popLast());
		})).next((() => t.store(ie).X({ Z: !0 }, (([e$1, t$1, n$1], r$1) => {
			return addEntry(__PRIVATE_decodeResourcePath(t$1).popLast());
		}))));
	}
	bi(e) {
		const t = e.store(Pe);
	...
	Di(e, t) {
		const n = t.store(j), r = [];
		return n.X(((e$1, n$1) => {
			const i = t.store(se), s = function __PRIVATE_extractKey(e$2) {
	...
	Ci(e, t) {
		...
		return n.j().next(((e$1) => {
			...
			return e$1.forEach(((e$2) => {
				var t$1;
				let r$1 = null !== (t$1 = n$1.get(e$2.userId)) && void 0 !== t$1 ? t$1 : __PRIVATE_documentKeySet();
				__PRIVATE_fromDbMutationBatch(this.serializer, e$2).keys().forEach(((e$3) => r$1 = r$1.add(e$3))), n$1.set(e$2.userId, r$1);
			})), PersistencePromise.forEach(n$1, ((e$2, n$2) => {
				const s = new User(n$2), o = __PRIVATE_IndexedDbDocumentOverlayCache.yt(this.serializer, s), _ = i.getIndexManager(s);
				return new LocalDocumentsView(r, __PRIVATE_IndexedDbMutationQueue.yt(s, this.serializer, _, i.referenceDelegate), o, _).recalculateAndSaveOverlaysForDocumentKeys(new __PRIVATE_IndexedDbTransaction(t, __PRIVATE_ListenSequence.ue), e$2).next();
			}));
		}));
	}
};
function __PRIVATE_createQueryCache(e) {
	e.createObjectStore(de, { keyPath: Ee }).createIndex(Ae, Re, { unique: !0 });
	e.createObjectStore(Pe, { keyPath: "targetId" }).createIndex(Te, Ie, { unique: !0 }), e.createObjectStore(me);
}
var Nt = "IndexedDbPersistence", Bt = 18e5, Lt = 5e3, kt = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", qt = "main";
/**
...
var __PRIVATE_IndexedDbPersistence = class __PRIVATE_IndexedDbPersistence {
	constructor(e, t, n, r, i, s, o, _, a, u, c = 18) {
		if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this.Fi = i, this.window = s, this.document = o, this.Mi = a, this.xi = u, this.Oi = c, this.ui = null, this.ci = !1, this.isPrimary = !1, this.networkEnabled = !0, this.Ni = null, this.inForeground = !1, this.Bi = null, this.Li = null, this.ki = Number.NEGATIVE_INFINITY, this.qi = (e$1) => Promise.resolve(), !__PRIVATE_IndexedDbPersistence.C()) throw new FirestoreError(N.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
	...
	*/ start() {
		return this.Ki().then((() => {
			if (!this.isPrimary && !this.allowTabSynchronization) throw new FirestoreError(N.FAILED_PRECONDITION, kt);
	...
	* PORTING NOTE: This is only used for Web multi-tab.
	*/ setNetworkEnabled(e) {
		this.networkEnabled !== e && (this.networkEnabled = e, this.Fi.enqueueAndForget((async () => {
	...
	*/ Ki() {
		return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", ((e) => __PRIVATE_clientMetadataStore(e).put({
			...
			if (this.isPrimary) return this.Ji(e).next(((e$1) => {
				e$1 || (this.isPrimary = !1, this.Fi.enqueueRetryable((() => this.qi(!1))));
			}));
		})).next((() => this.Hi(e))).next(((t) => this.isPrimary && !t ? this.Yi(e).next((() => !1)) : !!t && this.Zi(e).next((() => !0)))))).catch(((e) => {
			if (__PRIVATE_isIndexedDbTransactionError(e)) return __PRIVATE_logDebug(Nt, "Failed to extend owner lease: ", e), this.isPrimary;
			if (!this.allowTabSynchronization) throw e;
			return __PRIVATE_logDebug(Nt, "Releasing owner lease after error during lease refresh", e), !1;
		})).then(((e) => {
			this.isPrimary !== e && this.Fi.enqueueRetryable((() => this.qi(e))), this.isPrimary = e;
		}));
	}
	Ji(e) {
		return __PRIVATE_primaryClientStore(e).get(H).next(((e$1) => PersistencePromise.resolve(this.Xi(e$1))));
	}
	es(e) {
	...
	*/ async ts() {
		if (this.isPrimary && !this.ns(this.ki, Bt)) {
			...
			const e = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", ((e$1) => {
				const t = __PRIVATE_getStore(e$1, pe);
				return t.j().next(((e$2) => {
					const n = this.rs(e$2, Bt), r = e$2.filter(((e$3) => -1 === n.indexOf(e$3)));
	...
	*/ Hi(e) {
		...
		return __PRIVATE_primaryClientStore(e).get(H).next(((t) => {
			if (null !== t && this.ns(t.leaseTimestampMs, Lt) && !this._s(t.ownerId)) {
				...
				if (!this.Xi(t)) {
					if (!t.allowTabSynchronization) throw new FirestoreError(N.FAILED_PRECONDITION, kt);
					return !1;
				}
			}
			return !(!this.networkEnabled || !this.inForeground) || __PRIVATE_clientMetadataStore(e).j().next(((e$1) => void 0 === this.rs(e$1, Lt).find(((e$2) => {
		...
		})).next(((e$1) => (this.isPrimary !== e$1 && __PRIVATE_logDebug(Nt, `Client ${e$1 ? "is" : "is not"} eligible for a primary lease.`), e$1)));
	}
	async shutdown() {
		this.ci = !1, this.us(), this.Li && (this.Li.cancel(), this.Li = null), this.cs(), this.ls(), await this.$i.runTransaction("shutdown", "readwrite", [J, pe], ((e) => {
			const t = new __PRIVATE_IndexedDbTransaction(e, __PRIVATE_ListenSequence.ue);
			return this.Yi(t).next((() => this.es(t)));
		})), this.$i.close(), this.hs();
	}
	/**
	* Returns clients that are not zombied and have an updateTime within the
	* provided threshold.
	*/ rs(e, t) {
		return e.filter(((e$1) => this.ns(e$1.updateTimeMs, t) && !this._s(e$1.clientId)));
	}
	/**
	...
	* PORTING NOTE: This is only used for Web multi-tab.
	*/ Ps() {
		return this.runTransaction("getActiveClients", "readonly", ((e) => __PRIVATE_clientMetadataStore(e).j().next(((e$1) => this.rs(e$1, Bt).map(((e$2) => e$2.clientId))))));
	}
	get started() {
		return this.ci;
	}
	...
	runTransaction(e, t, n) {
		...
		const r = "readonly" === t ? "readonly" : "readwrite", i = function __PRIVATE_getObjectStores(e$1) {
			return 18 === e$1 ? rt : 17 === e$1 ? nt : 16 === e$1 ? tt : 15 === e$1 ? et : 14 === e$1 ? Xe : 13 === e$1 ? Ze : 12 === e$1 ? Ye : 11 === e$1 ? He : void fail(60245);
		}(this.Oi);
		let s;
		return this.$i.runTransaction(e, r, i, ((r$1) => (s = new __PRIVATE_IndexedDbTransaction(r$1, this.ui ? this.ui.next() : __PRIVATE_ListenSequence.ue), "readwrite-primary" === t ? this.Ji(s).next(((e$1) => !!e$1 || this.Hi(s))).next(((t$1) => {
			if (!t$1) throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = !1, this.Fi.enqueueRetryable((() => this.qi(!1))), new FirestoreError(N.FAILED_PRECONDITION, $);
			return n(s);
		})).next(((e$1) => this.Zi(s).next((() => e$1)))) : this.Ts(s).next((() => n(s)))))).then(((e$1) => (s.raiseOnCommittedEvent(), e$1)));
	}
	/**
	...
	*/
	Ts(e) {
		return __PRIVATE_primaryClientStore(e).get(H).next(((e$1) => {
			if (null !== e$1 && this.ns(e$1.leaseTimestampMs, Lt) && !this._s(e$1.ownerId) && !this.Xi(e$1) && !(this.xi || this.allowTabSynchronization && e$1.allowTabSynchronization)) throw new FirestoreError(N.FAILED_PRECONDITION, kt);
		}));
	}
	/**
	...
	*/ Zi(e) {
	...
	/** Checks the primary lease and removes it if we are the current primary. */ Yi(e) {
		...
		return t.get(H).next(((e$1) => this.Xi(e$1) ? (__PRIVATE_logDebug(Nt, "Releasing primary lease."), t.delete(H)) : PersistencePromise.resolve()));
	}
	...
	*/ Gi() {
		...
		"function" == typeof (null === (e = this.window) || void 0 === e ? void 0 : e.addEventListener) && (this.Ni = () => {
			this.us();
			const e$1 = /(?:Version|Mobile)\/1[456]/;
			isSafari() && (navigator.appVersion.match(e$1) || navigator.userAgent.match(e$1)) && this.Fi.enterRestrictedMode(!0), this.Fi.enqueueAndForget((() => this.shutdown()));
	...
	*/ _s(e) {
		...
		try {
			...
			return __PRIVATE_logError(Nt, "Failed to get zombied client id.", e$1), !1;
		}
	}
	/**
...
var __PRIVATE_QueryEngine = class {
	...
	/** Returns all local documents matching the specified query. */ getDocumentsMatchingQuery(e, t, n, r) {
		const i = { result: null };
		return this.ps(e, t).next(((e$1) => {
			i.result = e$1;
		})).next((() => {
			if (!i.result) return this.ys(e, t, r, n).next(((e$1) => {
				i.result = e$1;
			}));
		})).next((() => {
			if (i.result) return;
			const n$1 = new QueryContext();
			return this.ws(e, t, n$1).next(((r$1) => {
				if (i.result = r$1, this.Rs) return this.Ss(e, t, n$1, r$1.size);
			}));
		})).next((() => i.result));
	}
	Ss(e, t, n, r) {
	...
	*/ ps(e, t) {
		...
		return this.indexManager.getIndexType(e, n).next(((r) => 0 === r ? null : (null !== t.limit && 1 === r && (t = __PRIVATE_queryWithLimit(t, null, "F"), n = __PRIVATE_queryToTarget(t)), this.indexManager.getDocumentsMatchingTarget(e, n).next(((r$1) => {
			...
			return this.gs.getDocuments(e, i).next(((r$2) => this.indexManager.getMinOffset(e, n).next(((n$1) => {
				const s = this.bs(t, r$2);
				return this.Ds(t, s, i, n$1.readTime) ? this.ps(e, __PRIVATE_queryWithLimit(t, null, "F")) : this.vs(e, s, t, n$1);
			}))));
		})))));
	}
	/**
	...
	*/ ys(e, t, n, r) {
		return __PRIVATE_queryMatchesAllDocuments(t) || r.isEqual(SnapshotVersion.min()) ? PersistencePromise.resolve(null) : this.gs.getDocuments(e, n).next(((i) => {
			const s = this.bs(t, i);
			return this.Ds(t, s, n, r) ? PersistencePromise.resolve(null) : (__PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "Re-using previous result from %s to execute query: %s", r.toString(), __PRIVATE_stringifyQuery(t)), this.vs(e, s, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, Q)).next(((e$1) => e$1)));
		}));
	}
	...
	*/ vs(e, t, n, r) {
		return this.gs.getDocumentsMatchingQuery(e, n, r).next(((e$1) => (t.forEach(((t$1) => {
...
var __PRIVATE_LocalStoreImpl = class {
	constructor(e, t, n, r) {
		this.persistence = e, this.Cs = t, this.serializer = r, this.Fs = new SortedMap(__PRIVATE_primitiveComparator), this.Ms = new ObjectMap(((e$1) => __PRIVATE_canonifyTarget(e$1)), __PRIVATE_targetEquals), this.xs = /* @__PURE__ */ new Map(), this.Os = e.getRemoteDocumentCache(), this.hi = e.getTargetCache(), this.Ti = e.getBundleCache(), this.Ns(n);
	}
	Ns(e) {
...
async function __PRIVATE_localStoreHandleUserChange(e, t) {
	...
	return await n.persistence.runTransaction("Handle user change", "readonly", ((e$1) => {
		let r;
		return n.mutationQueue.getAllMutationBatches(e$1).next(((i) => (r = i, n.Ns(t), n.mutationQueue.getAllMutationBatches(e$1)))).next(((t$1) => {
			const i = [], s = [];
...
function __PRIVATE_localStoreAcknowledgeBatch(e, t) {
	...
	return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", ((e$1) => {
		const r = t.batch.keys(), i = n.Os.newChangeBuffer({ trackRemovals: !0 });
...
function __PRIVATE_localStoreGetLastRemoteSnapshotVersion(e) {
	const t = __PRIVATE_debugCast(e);
	return t.persistence.runTransaction("Get last remote snapshot version", "readonly", ((e$1) => t.hi.getLastRemoteSnapshotVersion(e$1)));
}
/**
...
*/ function __PRIVATE_localStoreApplyRemoteEventToLocalCache(e, t) {
	...
	return n.persistence.runTransaction("Apply remote event", "readwrite-primary", ((e$1) => {
		...
		t.targetChanges.forEach(((s$1, _$1) => {
			const a$1 = i.get(_$1);
			if (!a$1) return;
			o.push(n.hi.removeMatchingKeys(e$1, s$1.removedDocuments, _$1).next((() => n.hi.addMatchingKeys(e$1, s$1.addedDocuments, _$1))));
			...
			null !== t.targetMismatches.get(_$1) ? u = u.withResumeToken(ByteString.EMPTY_BYTE_STRING, SnapshotVersion.min()).withLastLimboFreeSnapshotVersion(SnapshotVersion.min()) : s$1.resumeToken.approximateByteSize() > 0 && (u = u.withResumeToken(s$1.resumeToken, r)), i = i.insert(_$1, u), function __PRIVATE_shouldPersistTargetData(e$2, t$1, n$1) {
				...
				if (t$1.snapshotVersion.toMicroseconds() - e$2.snapshotVersion.toMicroseconds() >= $t) return !0;
				return n$1.addedDocuments.size + n$1.modifiedDocuments.size + n$1.removedDocuments.size > 0;
			}(a$1, u, s$1) && o.push(n.hi.updateTargetData(e$1, u));
		}));
		...
		if (t.documentUpdates.forEach(((r$1) => {
			...
			const t$1 = n.hi.getLastRemoteSnapshotVersion(e$1).next(((t$2) => n.hi.setTargetsMetadata(e$1, e$1.currentSequenceNumber, r)));
			o.push(t$1);
		}
...
function __PRIVATE_localStoreGetNextMutationBatch(e, t) {
	const n = __PRIVATE_debugCast(e);
	return n.persistence.runTransaction("Get next mutation batch", "readonly", ((e$1) => (void 0 === t && (t = G), n.mutationQueue.getNextMutationBatchAfterBatchId(e$1, t))));
}
/**
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
	...
	return n.persistence.runTransaction("Allocate target", "readwrite", ((e$1) => {
		let r;
		return n.hi.getTargetData(e$1, t).next(((i) => i ? (r = i, PersistencePromise.resolve(r)) : n.hi.allocateTargetId(e$1).next(((i$1) => (r = new TargetData(t, i$1, "TargetPurposeListen", e$1.currentSequenceNumber), n.hi.addTargetData(e$1, r).next((() => r)))))));
	})).then(((e$1) => {
		const r = n.Fs.get(e$1.targetId);
		return (null === r || e$1.snapshotVersion.compareTo(r.snapshotVersion) > 0) && (n.Fs = n.Fs.insert(e$1.targetId, e$1), n.Ms.set(t, e$1.targetId)), e$1;
	}));
}
/**
...
async function __PRIVATE_localStoreReleaseTarget(e, t, n) {
	...
	try {
		...
		__PRIVATE_logDebug(Qt, `Failed to update sequence numbers for target ${t}: ${e$1}`);
	}
...
*/ function __PRIVATE_localStoreExecuteQuery(e, t, n) {
	...
	return r.persistence.runTransaction("Execute query", "readwrite", ((e$1) => function __PRIVATE_localStoreGetTargetData(e$2, t$1, n$1) {
		const r$1 = __PRIVATE_debugCast(e$2), i$1 = r$1.Ms.get(n$1);
		return void 0 !== i$1 ? PersistencePromise.resolve(r$1.Fs.get(i$1)) : r$1.hi.getTargetData(t$1, n$1);
	}(r, e$1, __PRIVATE_queryToTarget(t)).next(((t$1) => {
		if (t$1) return i = t$1.lastLimboFreeSnapshotVersion, r.hi.getMatchingKeysForTargetId(e$1, t$1.targetId).next(((e$2) => {
			s = e$2;
		}));
...
function __PRIVATE_localStoreGetCachedTarget(e, t) {
	...
	return i ? Promise.resolve(i.target) : n.persistence.runTransaction("Get target data", "readonly", ((e$1) => r.Et(e$1, t).next(((e$2) => e$2 ? e$2.target : null))));
}
/**
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
	...
	return n.persistence.runTransaction("Get new document changes", "readonly", ((e$1) => n.Os.getAllFromCollectionGroup(e$1, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, Q), Number.MAX_SAFE_INTEGER))).then(((e$1) => (__PRIVATE_setMaxReadTime(n, t, e$1), e$1)));
}
...
async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r) {
	...
	for (const e$1 of n) {
		const n$1 = t.Qs(e$1.metadata.name);
		e$1.document && (s = s.add(n$1));
		const r$1 = t.$s(e$1);
		r$1.setReadTime(t.Us(e$1.metadata.readTime)), o = o.insert(n$1, r$1);
	}
	const _ = i.Os.newChangeBuffer({ trackRemovals: !0 }), a = await __PRIVATE_localStoreAllocateTarget(i, function __PRIVATE_umbrellaTarget(e$1) {
		return __PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(ResourcePath.fromString(`__bundle__/docs/${e$1}`)));
	}(r));
	return i.persistence.runTransaction("Apply bundle documents", "readwrite", ((e$1) => __PRIVATE_populateDocumentChangeBuffer(e$1, _, o).next(((t$1) => (_.apply(e$1), t$1))).next(((t$1) => i.hi.removeMatchingKeysForTargetId(e$1, a.targetId).next((() => i.hi.addMatchingKeys(e$1, s, a.targetId))).next((() => i.localDocuments.getLocalViewOfDocuments(e$1, t$1.Ls, t$1.ks))).next((() => t$1.Ls))))));
}
/**
...
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
	...
	return i.persistence.runTransaction("Save named query", "readwrite", ((e$1) => {
		...
		if (r.snapshotVersion.compareTo(s) >= 0) return i.Ti.saveNamedQuery(e$1, t);
		const o = r.withResumeToken(ByteString.EMPTY_BYTE_STRING, s);
		return i.Fs = i.Fs.insert(o.targetId, o), i.hi.updateTargetData(e$1, o).next((() => i.hi.removeMatchingKeysForTargetId(e$1, r.targetId))).next((() => i.hi.addMatchingKeys(e$1, n, r.targetId))).next((() => i.Ti.saveNamedQuery(e$1, t)));
	}));
}
/**
* @license
...
*/ var __PRIVATE_WebStorageSharedClientState = class {
	constructor(e, t, n, r, i) {
		this.window = e, this.Fi = t, this.persistenceKey = n, this.js = r, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.Js = this.Hs.bind(this), this.Ys = new SortedMap(__PRIVATE_primitiveComparator), this.started = !1, this.Zs = [];
		const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
		this.storage = this.window.localStorage, this.currentUser = i, this.Xs = createWebStorageClientStateKey(this.persistenceKey, this.js), this.eo = function createWebStorageSequenceNumberKey(e$1) {
			return `firestore_sequence_number_${e$1}`;
		}(this.persistenceKey), this.Ys = this.Ys.insert(this.js, new __PRIVATE_LocalClientState()), this.no = /* @__PURE__ */ new RegExp(`^${Ut}_${s}_([^_]*)$`), this.ro = /* @__PURE__ */ new RegExp(`^${Kt}_${s}_(\\d+)(?:_(.*))?$`), this.io = /* @__PURE__ */ new RegExp(`^${Wt}_${s}_(\\d+)$`), this.so = function createWebStorageOnlineStateKey(e$1) {
			return `firestore_online_state_${e$1}`;
		}(this.persistenceKey), this.oo = function createBundleLoadedKey(e$1) {
	...
	async start() {
		...
		for (const t$1 of e) {
			...
			if (e$1) {
				const n = __PRIVATE_RemoteClientState.Ks(t$1, e$1);
	...
	addLocalQueryTarget(e, t = !0) {
		...
		if (this.isActiveQueryTarget(e)) {
			...
			if (t$1) {
				const r = __PRIVATE_QueryTargetMetadata.Ks(e, t$1);
				r && (n = r.state);
			}
		}
					...
					if (null !== t.key) {
						if (this.no.test(t.key)) {
							...
							if (null !== t.newValue) {
								...
								if (e$1) return this.fo(e$1);
							}
						} else if (this.io.test(t.key)) {
							if (null !== t.newValue) {
								const e$1 = this.po(t.key, t.newValue);
								if (e$1) return this.yo(e$1);
							}
						} else if (t.key === this.so) {
							if (null !== t.newValue) {
								const e$1 = this.ao(t.newValue);
								if (e$1) return this.uo(e$1);
							}
						} else if (t.key === this.eo) {
							const e$1 = function __PRIVATE_fromWebStorageSequenceNumber(e$2) {
								let t$1 = __PRIVATE_ListenSequence.ue;
								if (null != e$2) try {
									const n = JSON.parse(e$2);
									__PRIVATE_hardAssert("number" == typeof n, 30636, { wo: e$2 }), t$1 = n;
								} catch (e$3) {
									__PRIVATE_logError(Gt, "Failed to read sequence number from WebStorage", e$3);
								}
								return t$1;
							}(t.newValue);
							e$1 !== __PRIVATE_ListenSequence.ue && this.sequenceNumberHandler(e$1);
						} else if (t.key === this.oo) {
							const e$1 = this.So(t.newValue);
...
var __PRIVATE_RestConnection = class {
	...
	Wo(e, t, n, r, i) {
		...
		return this.jo(e, o, _, n, u).then(((t$1) => (__PRIVATE_logDebug(Jt, `Received RPC '${e}' ${s}: `, t$1), t$1)), ((t$1) => {
			throw __PRIVATE_logWarn(Jt, `RPC '${e}' ${s} failed with error: `, t$1, "url: ", o, "request:", n), t$1;
		}));
	}
	Jo(e, t, n, r, i, s) {
...
var __PRIVATE_WebChannelConnection = class extends __PRIVATE_RestConnection {
				...
				try {
					switch (_.getLastErrorCode()) {
						case ErrorCode.NO_ERROR:
							...
							__PRIVATE_logDebug(Yt, `XHR for RPC '${e}' ${s} received:`, JSON.stringify(t$1)), i$1(t$1);
							break;
						...
						case ErrorCode.HTTP_ERROR:
							...
							if (__PRIVATE_logDebug(Yt, `RPC '${e}' ${s} failed with status:`, n$1, "response text:", _.getResponseText()), n$1 > 0) {
								let e$1 = _.getResponseJson();
								Array.isArray(e$1) && (e$1 = e$1[0]);
								const t$2 = null == e$1 ? void 0 : e$1.error;
								if (t$2 && t$2.status && t$2.message) o(new FirestoreError(function __PRIVATE_mapCodeFromHttpResponseErrorStatus(e$2) {
									const t$3 = e$2.toLowerCase().replace(/_/g, "-");
									return Object.values(N).indexOf(t$3) >= 0 ? t$3 : N.UNKNOWN;
								}(t$2.status), t$2.message));
	...
	P_(e, t, n) {
		...
		const P = new __PRIVATE_StreamBridge({
			Ho: (t$1) => {
				h ? __PRIVATE_logDebug(Yt, `Not sending because RPC '${e}' stream ${r} is closed:`, t$1) : (l || (__PRIVATE_logDebug(Yt, `Opening RPC '${e}' stream ${r} transport.`), c.open(), l = !0), __PRIVATE_logDebug(Yt, `RPC '${e}' stream ${r} sending:`, t$1), c.send(t$1));
			},
			Yo: () => c.close()
		...
		return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, (() => {
			...
			h || (h = !0, __PRIVATE_logWarn(Yt, `RPC '${e}' stream ${r} transport errored. Name:`, t$1.name, "Message:", t$1.message), P.__(new FirestoreError(N.UNAVAILABLE, "The operation could not be completed")));
		})), __PRIVATE_unguardedEventListen(c, WebChannel.EventType.MESSAGE, ((t$1) => {
			var n$1;
			if (!h) {
				const i$1 = t$1.data[0];
				__PRIVATE_hardAssert(!!i$1, 16349);
				const s$1 = i$1, o$1 = (null == s$1 ? void 0 : s$1.error) || (null === (n$1 = s$1[0]) || void 0 === n$1 ? void 0 : n$1.error);
				if (o$1) {
					__PRIVATE_logDebug(Yt, `RPC '${e}' stream ${r} received error:`, o$1);
					const t$2 = o$1.status;
					let n$2 = function __PRIVATE_mapCodeFromRpcStatus(e$1) {
						const t$3 = ft[e$1];
						if (void 0 !== t$3) return __PRIVATE_mapCodeFromRpcCode(t$3);
					}(t$2), i$2 = o$1.message;
					void 0 === n$2 && (n$2 = N.INTERNAL, i$2 = "Unknown error status: " + t$2 + " with message " + o$1.message), h = !0, P.__(new FirestoreError(n$2, i$2)), c.close();
				} else __PRIVATE_logDebug(Yt, `RPC '${e}' stream ${r} received:`, i$1), P.a_(i$1);
			}
		})), __PRIVATE_unguardedEventListen(o, Event.STAT_EVENT, ((t$1) => {
			t$1.stat === Stat.PROXY ? __PRIVATE_logDebug(Yt, `RPC '${e}' stream ${r} detected buffering proxy`) : t$1.stat === Stat.NOPROXY && __PRIVATE_logDebug(Yt, `RPC '${e}' stream ${r} detected no buffering proxy`);
		})), setTimeout((() => {
			P.o_();
		}), 0), P;
	}
...
var __PRIVATE_PersistentStream = class {
	constructor(e, t, n, r, i, s, o, _) {
		this.Fi = e, this.w_ = n, this.S_ = r, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, this.b_ = 0, this.D_ = null, this.v_ = null, this.stream = null, this.C_ = 0, this.F_ = new __PRIVATE_ExponentialBackoff(e, t);
	}
	/**
	...
	*/ U_() {}
	...
	W_(e, t) {
		...
		this.stream = this.z_(e, t), this.stream.Zo((() => {
			...
			n((() => 1 == ++this.C_ ? this.j_(e$1) : this.onNext(e$1)));
		}));
	}
	O_() {
...
*/ var __PRIVATE_PersistentListenStream = class extends __PRIVATE_PersistentStream {
	...
	*/ H_(e) {
		...
		t.database = __PRIVATE_getEncodedDatabaseId(this.serializer), t.addTarget = function __PRIVATE_toTarget(e$1, t$1) {
			let n$1;
			const r = t$1.target;
			if (n$1 = __PRIVATE_targetIsDocumentTarget(r) ? { documents: __PRIVATE_toDocumentsTarget(e$1, r) } : { query: __PRIVATE_toQueryTarget(e$1, r).Vt }, n$1.targetId = t$1.targetId, t$1.resumeToken.approximateByteSize() > 0) {
...
*/ var __PRIVATE_DatastoreImpl = class extends Datastore {
	...
	/** Invokes the provided RPC with auth and AppCheck tokens. */ Wo(e, t, n, r) {
		return this.ia(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then((([i, s]) => this.connection.Wo(e, __PRIVATE_toResourcePath(t, n), r, i, s))).catch(((e$1) => {
	...
	/** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ Jo(e, t, n, r, i) {
		return this.ia(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then((([s, o]) => this.connection.Jo(e, __PRIVATE_toResourcePath(t, n), r, s, o, i))).catch(((e$1) => {
			throw "FirebaseError" === e$1.name ? (e$1.code === N.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), e$1) : new FirestoreError(N.UNKNOWN, e$1.toString());
		}));
	}
	terminate() {
...
var __PRIVATE_RemoteStoreImpl = class {
	constructor(e, t, n, r, i) {
		this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.Pa = [], this.Ta = /* @__PURE__ */ new Map(), this.Ia = /* @__PURE__ */ new Set(), this.da = [], this.Ea = i, this.Ea.xo(((e$1) => {
			n.enqueueAndForget((async () => {
				__PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(Xt, "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e$2) {
					const t$1 = __PRIVATE_debugCast(e$2);
					t$1.Ia.add(4), await __PRIVATE_disableNetworkInternal(t$1), t$1.Aa.set("Unknown"), t$1.Ia.delete(4), await __PRIVATE_enableNetworkInternal(t$1);
				}(this));
			}));
...
function __PRIVATE_remoteStoreListen(e, t) {
	const n = __PRIVATE_debugCast(e);
	n.Ta.has(t.targetId) || (n.Ta.set(t.targetId, t), __PRIVATE_shouldStartWatchStream(n) ? __PRIVATE_startWatchStream(n) : __PRIVATE_ensureWatchStream(n).x_() && __PRIVATE_sendWatchRequest(n, t));
}
/**
...
*/ function __PRIVATE_remoteStoreUnlisten(e, t) {
	...
	n.Ta.delete(t), r.x_() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.Ta.size && (r.x_() ? r.B_() : __PRIVATE_canUseNetwork(n) && n.Aa.set("Unknown"));
}
/**
...
async function __PRIVATE_onWatchStreamClose(e, t) {
	__PRIVATE_cleanUpWatchStreamState(e), __PRIVATE_shouldStartWatchStream(e) ? (e.Aa.la(t), __PRIVATE_startWatchStream(e)) : e.Aa.set("Unknown");
}
async function __PRIVATE_onWatchStreamChange(e, t, n) {
	if (e.Aa.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause) try {
		/** Handles an error on a target */
		await async function __PRIVATE_handleTargetError(e$1, t$1) {
			const n$1 = t$1.cause;
			for (const r of t$1.targetIds) e$1.Ta.has(r) && (await e$1.remoteSyncer.rejectListen(r, n$1), e$1.Ta.delete(r), e$1.Ra.removeTarget(r));
		}(e, t);
	} catch (n$1) {
		__PRIVATE_logDebug(Xt, "Failed to remove targets %s: %s ", t.targetIds.join(","), n$1), await __PRIVATE_disableNetworkUntilRecovery(e, n$1);
	}
		...
		n.compareTo(t$1) >= 0 && await function __PRIVATE_raiseWatchSnapshot(e$1, t$2) {
			const n$1 = e$1.Ra.Pt(t$2);
			return n$1.targetChanges.forEach(((n$2, r) => {
				if (n$2.resumeToken.approximateByteSize() > 0) {
					const i = e$1.Ta.get(r);
					i && e$1.Ta.set(r, i.withResumeToken(n$2.resumeToken, t$2));
				}
			})), n$1.targetMismatches.forEach(((t$3, n$2) => {
				const r = e$1.Ta.get(t$3);
				if (!r) return;
				e$1.Ta.set(t$3, r.withResumeToken(ByteString.EMPTY_BYTE_STRING, r.snapshotVersion)), __PRIVATE_sendUnwatchRequest(e$1, t$3);
				__PRIVATE_sendWatchRequest(e$1, new TargetData(r.target, t$3, n$2, r.sequenceNumber));
			})), e$1.remoteSyncer.applyRemoteEvent(n$1);
		}(e, n);
	} catch (t$1) {
		__PRIVATE_logDebug(Xt, "Failed to raise snapshot:", t$1), await __PRIVATE_disableNetworkUntilRecovery(e, t$1);
	}
}
/**
...
*/ async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
	...
	e.Ia.add(1), await __PRIVATE_disableNetworkInternal(e), e.Aa.set("Offline"), n || (n = () => __PRIVATE_localStoreGetLastRemoteSnapshotVersion(e.localStore)), e.asyncQueue.enqueueRetryable((async () => {
		__PRIVATE_logDebug(Xt, "Retrying IndexedDB access"), await n(), e.Ia.delete(1), await __PRIVATE_enableNetworkInternal(e);
	}));
}
/**
...
async function __PRIVATE_onWriteStreamClose(e, t) {
	t && __PRIVATE_ensureWriteStream(e).Z_ && await async function __PRIVATE_handleWriteError(e$1, t$1) {
		if (function __PRIVATE_isPermanentWriteError(e$2) {
			return __PRIVATE_isPermanentError(e$2) && e$2 !== N.ABORTED;
		}(t$1.code)) {
			const n = e$1.Pa.shift();
			__PRIVATE_ensureWriteStream(e$1).N_(), await __PRIVATE_executeWithRecovery(e$1, (() => e$1.remoteSyncer.rejectFailedWrite(n.batchId, t$1))), await __PRIVATE_fillWritePipeline(e$1);
		}
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
	...
	n.Ia.add(3), await __PRIVATE_disableNetworkInternal(n), r && n.Aa.set("Unknown"), await n.remoteSyncer.handleCredentialChange(t), n.Ia.delete(3), await __PRIVATE_enableNetworkInternal(n);
}
/**
...
*/ function __PRIVATE_ensureWatchStream(e) {
	return e.Va || (e.Va = function __PRIVATE_newPersistentWatchStream(e$1, t, n) {
		...
		t ? (e.Va.N_(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.Aa.set("Unknown")) : (await e.Va.stop(), __PRIVATE_cleanUpWatchStreamState(e));
	}))), e.Va;
}
/**
...
*/ function __PRIVATE_ensureWriteStream(e) {
	return e.ma || (e.ma = function __PRIVATE_newPersistentWriteStream(e$1, t, n) {
		const r = __PRIVATE_debugCast(e$1);
		...
		t ? (e.ma.N_(), await __PRIVATE_fillWritePipeline(e)) : (await e.ma.stop(), e.Pa.length > 0 && (__PRIVATE_logDebug(Xt, `Stopping write stream with ${e.Pa.length} pending writes`), e.Pa = []));
	}))), e.ma;
}
/**
* @license
...
*/ var __PRIVATE_DocumentChangeSet = class {
	...
	track(e) {
		...
		n ? 0 !== e.type && 3 === n.type ? this.fa = this.fa.insert(t, e) : 3 === e.type && 1 !== n.type ? this.fa = this.fa.insert(t, {
			type: n.type,
			doc: e.doc
	...
	terminate() {
		(function __PRIVATE_errorAllTargets(e, t) {
			...
			n.queries = __PRIVATE_newQueriesObjectMap(), r.forEach(((e$1, n$1) => {
				for (const e$2 of n$1.wa) e$2.onError(t);
			}));
...
async function __PRIVATE_eventManagerListen(e, t) {
	...
	s ? !s.Sa() && t.ba() && (r = 2) : (s = new __PRIVATE_QueryListenersInfo(), r = t.ba() ? 0 : 1);
	try {
		switch (r) {
			case 0:
	...
	if (n.queries.set(i, s), s.wa.push(t), t.va(n.onlineState), s.ya) t.Ca(s.ya) && __PRIVATE_raiseSnapshotsInSyncEvent(n);
}
async function __PRIVATE_eventManagerUnlisten(e, t) {
	...
	if (s) {
		const e$1 = s.wa.indexOf(t);
		e$1 >= 0 && (s.wa.splice(e$1, 1), 0 === s.wa.length ? i = t.ba() ? 0 : 1 : !s.Sa() && t.ba() && (i = 2));
	}
	switch (i) {
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
	...
	for (const e$1 of t) {
		...
		if (i) {
			for (const t$2 of i.wa) t$2.Ca(e$1) && (r = !0);
			i.ya = e$1;
		}
	}
...
function __PRIVATE_eventManagerOnWatchError(e, t, n) {
	...
	if (i) for (const e$1 of i.wa) e$1.onError(n);
	r.queries.delete(t);
}
...
var __PRIVATE_QueryListener = class {
	constructor(e, t, n) {
		this.query = e, this.Ma = t, this.xa = !1, this.Oa = null, this.onlineState = "Unknown", this.options = n || {};
	}
	/**
...
*/ var __PRIVATE_BundleLoader = class {
	constructor(e, t) {
		this.$a = e, this.serializer = t, this.Ua = [], this.Ka = [], this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = __PRIVATE_bundleInitialProgress(e);
	}
	/**
	...
	*/ Wa(e) {
		...
		if (e.qa.namedQuery) this.Ua.push(e.qa.namedQuery);
			...
			this.Ka.push({ metadata: e.qa.documentMetadata }), e.qa.documentMetadata.exists || ++t;
	...
	Ga(e) {
		...
		for (const r of e) if (r.metadata.queries) {
			const e$1 = n.Qs(r.metadata.name);
	...
	*/ async za(e) {
		...
		for (const t$1 of this.Ua) await __PRIVATE_localStoreSaveNamedQuery(e, t$1, n.get(t$1.name));
...
*/ var __PRIVATE_View = class {
	constructor(e, t) {
		this.query = e, this.Ha = t, this.Ya = null, this.hasCachedResults = !1, this.current = !1, this.Za = __PRIVATE_documentKeySet(), this.mutatedKeys = __PRIVATE_documentKeySet(), this.Xa = __PRIVATE_newQueryComparator(e), this.eu = new DocumentSet(this.Xa);
	}
	/**
	...
	*/ nu(e, t) {
		...
		if (e.inorderTraversal(((e$1, t$1) => {
			...
			if (u && c) u.data.isEqual(c.data) ? l !== h && (n.track({
				...
				type: 2,
				doc: c
			}), P = !0, (_ && this.Xa(c, _) > 0 || a && this.Xa(c, a) < 0) && (o = !0));
			else !u && c ? (n.track({
				type: 0,
				doc: c
			}), P = !0) : u && !c && (n.track({
		...
		s.sort(((e$1, t$1) => function __PRIVATE_compareChangeType(e$2, t$2) {
			const order = (e$3) => {
				switch (e$3) {
					...
					case 3: return 2;
					case 1: return 0;
					default: return fail(20277, { At: e$3 });
				}
			};
			return order(e$2) - order(t$2);
		}(e$1.type, t$1.type) || this.Xa(e$1.doc, t$1.doc))), this.su(n), r = null != r && r;
		const o = t && !r ? this.ou() : [], _ = 0 === this.Za.size && this.current && !r ? 1 : 0, a = _ !== this.Ya;
		if (this.Ya = _, 0 !== s.length || a) return {
			snapshot: new ViewSnapshot(this.query, e.eu, i, s, e.mutatedKeys, 0 === _, a, !1, !!n && n.resumeToken.approximateByteSize() > 0),
			_u: o
		};
		return { _u: o };
	}
	...
	*/ su(e) {
		e && (e.addedDocuments.forEach(((e$1) => this.Ha = this.Ha.add(e$1))), e.modifiedDocuments.forEach(((e$1) => {})), e.removedDocuments.forEach(((e$1) => this.Ha = this.Ha.delete(e$1))), this.current = e.current);
	}
	ou() {
		if (!this.current) return [];
		const e = this.Za;
		this.Za = __PRIVATE_documentKeySet(), this.eu.forEach(((e$1) => {
			this.au(e$1.key) && (this.Za = this.Za.add(e$1.key));
		}));
		const t = [];
		return e.forEach(((e$1) => {
			this.Za.has(e$1) || t.push(new __PRIVATE_RemovedLimboDocument(e$1));
		})), this.Za.forEach(((n) => {
...
*/ var __PRIVATE_SyncEngineImpl = class {
	constructor(e, t, n, r, i, s) {
		this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.hu = {}, this.Pu = new ObjectMap(((e$1) => __PRIVATE_canonifyQuery(e$1)), __PRIVATE_queryEquals), this.Tu = /* @__PURE__ */ new Map(), this.Iu = /* @__PURE__ */ new Set(), this.du = new SortedMap(DocumentKey.comparator), this.Eu = /* @__PURE__ */ new Map(), this.Au = new __PRIVATE_ReferenceSet(), this.Ru = {}, this.Vu = /* @__PURE__ */ new Map(), this.mu = __PRIVATE_TargetIdGenerator.ur(), this.onlineState = "Unknown", this.fu = void 0;
	}
	get isPrimaryClient() {
		return !0 === this.fu;
	}
...
async function __PRIVATE_syncEngineListen(e, t, n = !0) {
	...
	let i;
	const s = r.Pu.get(t);
	return s ? (r.sharedClientState.addLocalQueryTarget(s.targetId), i = s.view.cu()) : i = await __PRIVATE_allocateTargetAndMaybeListen(
		r,
		t,
		n,
...
*/ async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
	e.gu = (t$1, n$1, r$1) => async function __PRIVATE_applyDocChanges(e$1, t$2, n$2, r$2) {
		let i$1 = t$2.view.nu(n$2);
		i$1.Ds && (i$1 = await __PRIVATE_localStoreExecuteQuery(e$1.localStore, t$2.query, !1).then((({ documents: e$2 }) => t$2.view.nu(e$2, i$1))));
		...
		return __PRIVATE_updateTrackedLimbos(e$1, t$2.targetId, _$1._u), _$1.snapshot;
	}(e, t$1, n$1, r$1);
	const s = await __PRIVATE_localStoreExecuteQuery(e.localStore, t, !0), o = new __PRIVATE_View(t, s.qs), _ = o.nu(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" !== e.onlineState, i), u = o.applyChanges(_, e.isPrimaryClient, a);
...
/** Stops listening to the query. */ async function __PRIVATE_syncEngineUnlisten(e, t, n) {
	...
	if (s.length > 1) return r.Tu.set(i.targetId, s.filter(((e$1) => !__PRIVATE_queryEquals(e$1, t)))), void r.Pu.delete(t);
	...
	try {
		const e$1 = await function __PRIVATE_localStoreWriteLocally(e$2, t$1) {
			...
			return n$1.persistence.runTransaction("Locally write mutations", "readwrite", ((e$3) => {
				let _ = __PRIVATE_mutableDocumentMap(), a = __PRIVATE_documentKeySet();
				return n$1.Os.getEntries(e$3, i).next(((e$4) => {
		...
		r.sharedClientState.addPendingMutation(e$1.batchId), function __PRIVATE_addMutationCallback(e$2, t$1, n$1) {
			let r$1 = e$2.Ru[e$2.currentUser.toKey()];
			r$1 || (r$1 = new SortedMap(__PRIVATE_primitiveComparator));
			r$1 = r$1.insert(t$1, n$1), e$2.Ru[e$2.currentUser.toKey()] = r$1;
...
*/ async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
	...
	try {
		...
		t.targetChanges.forEach(((e$2, t$1) => {
			const r = n.Eu.get(t$1);
			r && (__PRIVATE_hardAssert(e$2.addedDocuments.size + e$2.modifiedDocuments.size + e$2.removedDocuments.size <= 1, 22616), e$2.addedDocuments.size > 0 ? r.lu = !0 : e$2.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r.lu, 14607) : e$2.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r.lu, 42227), r.lu = !1));
	...
	if (r.isPrimaryClient && 0 === n || !r.isPrimaryClient && 1 === n) {
		...
		r.Pu.forEach(((n$1, r$1) => {
			...
			n$1.queries.forEach(((e$3, n$2) => {
				for (const e$4 of n$2.wa) e$4.va(t$1) && (r$1 = !0);
			})), r$1 && __PRIVATE_raiseSnapshotsInSyncEvent(n$1);
		}(r.eventManager, t), e$1.length && r.hu.J_(e$1), r.onlineState = t, r.isPrimaryClient && r.sharedClientState.setOnlineState(t);
	}
}
/**
...
*/ async function __PRIVATE_syncEngineRejectListen(e, t, n) {
	...
	if (s) {
		...
		const n$1 = __PRIVATE_documentKeySet().add(s);
		await __PRIVATE_syncEngineApplyRemoteEvent(r, new RemoteEvent(SnapshotVersion.min(), /* @__PURE__ */ new Map(), new SortedMap(__PRIVATE_primitiveComparator), e$1, n$1)), r.du = r.du.remove(s), r.Eu.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r);
...
*/ async function __PRIVATE_syncEngineRegisterPendingWritesCallback(e, t) {
	...
	try {
		...
		if (e$1 === G) return void t.resolve();
		const r = n.Vu.get(e$1) || [];
		r.push(t), n.Vu.set(e$1, r);
	} catch (e$1) {
...
/** Reject all outstanding callbacks waiting for pending writes to complete. */ function __PRIVATE_processUserCallback(e, t, n) {
	...
	if (i) {
		const e$1 = i.get(t);
		e$1 && (n ? e$1.reject(n) : e$1.resolve(), i = i.remove(t)), r.Ru[r.currentUser.toKey()] = i;
	}
}
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
	e.sharedClientState.removeLocalQueryTarget(t);
	for (const r of e.Tu.get(t)) e.Pu.delete(r), n && e.hu.pu(r, n);
	if (e.Tu.delete(t), e.isPrimaryClient) e.Au.zr(t).forEach(((t$1) => {
		e.Au.containsKey(t$1) || __PRIVATE_removeLimboTarget(e, t$1);
	}));
}
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
	for (const r of n) if (r instanceof __PRIVATE_AddedLimboDocument) e.Au.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
		...
		e.Au.containsKey(r.key) || __PRIVATE_removeLimboTarget(e, r.key);
	} else fail(19791, { yu: r });
}
...
async function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
	...
	r.Pu.isEmpty() || (r.Pu.forEach(((e$1, _) => {
		o.push(r.gu(_, t, n).then(((e$2) => {
			var t$1;
			if ((e$2 || n) && r.isPrimaryClient) {
				const i$1 = e$2 ? !e$2.fromCache : null === (t$1 = null == n ? void 0 : n.targetChanges.get(_.targetId)) || void 0 === t$1 ? void 0 : t$1.current;
				r.sharedClientState.updateQueryState(_.targetId, i$1 ? "current" : "not-current");
			}
			if (e$2) {
				i.push(e$2);
				const t$2 = __PRIVATE_LocalViewChanges.Es(_.targetId, e$2);
				s.push(t$2);
			}
		})));
	})), await Promise.all(o), r.hu.J_(i), await async function __PRIVATE_localStoreNotifyLocalViewChanges(e$1, t$1) {
		const n$1 = __PRIVATE_debugCast(e$1);
		try {
			await n$1.persistence.runTransaction("notifyLocalViewChanges", "readwrite", ((e$2) => PersistencePromise.forEach(t$1, ((t$2) => PersistencePromise.forEach(t$2.Is, ((r$1) => n$1.persistence.referenceDelegate.addReference(e$2, t$2.targetId, r$1))).next((() => PersistencePromise.forEach(t$2.ds, ((r$1) => n$1.persistence.referenceDelegate.removeReference(e$2, t$2.targetId, r$1)))))))));
		} catch (e$2) {
			if (!__PRIVATE_isIndexedDbTransactionError(e$2)) throw e$2;
			__PRIVATE_logDebug(Qt, "Failed to update sequence numbers: " + e$2);
		}
		for (const e$2 of t$1) {
			const t$2 = e$2.targetId;
			if (!e$2.fromCache) {
				const e$3 = n$1.Fs.get(t$2), r$1 = e$3.snapshotVersion, i$1 = e$3.withLastLimboFreeSnapshotVersion(r$1);
				n$1.Fs = n$1.Fs.insert(t$2, i$1);
			}
		}
	}(r.localStore, s));
}
async function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
	...
	if (!n.currentUser.isEqual(t)) {
		...
		}(n, "'waitForPendingWrites' promise is rejected due to a user change."), n.sharedClientState.handleUserChange(t, e$1.removedBatchIds, e$1.addedBatchIds), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e$1.Bs);
	}
}
function __PRIVATE_syncEngineGetRemoteKeysForTarget(e, t) {
	...
	{
		let e$1 = __PRIVATE_documentKeySet();
		const r$1 = n.Tu.get(t);
		if (!r$1) return e$1;
		for (const t$1 of r$1) {
			const r$2 = n.Pu.get(t$1);
			e$1 = e$1.unionWith(r$2.view.tu);
		}
		return e$1;
	}
}
...
*/ async function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
	const n = __PRIVATE_debugCast(e), r = await __PRIVATE_localStoreExecuteQuery(n.localStore, t.query, !0), i = t.view.uu(r);
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
	...
	null !== s ? ("pending" === n ? await __PRIVATE_fillWritePipeline(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (__PRIVATE_processUserCallback(i, t, r || null), __PRIVATE_triggerPendingWritesCallbacks(i, t), function __PRIVATE_localStoreRemoveCachedMutationBatchMetadata(e$1, t$1) {
		__PRIVATE_debugCast(__PRIVATE_debugCast(e$1).mutationQueue).rr(t$1);
	}(i.localStore, t)) : fail(6720, "Unknown batchState", { wu: n }), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(i, s)) : __PRIVATE_logDebug(nn, "Cannot apply mutation batch with id: " + t);
}
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
	...
	if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), !0 === t && !0 !== n.fu) {
		const t$1 = await __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(n, n.sharedClientState.getAllActiveQueryTargets().toArray());
		n.fu = !0, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, !0);
		for (const e$1 of t$1) __PRIVATE_remoteStoreListen(n.remoteStore, e$1);
	} else if (!1 === t && !1 !== n.fu) {
		const e$1 = [];
		...
		n.Tu.forEach(((r, i) => {
			...
			t$2.Eu.forEach(((e$3, n$1) => {
				__PRIVATE_remoteStoreUnlisten(t$2.remoteStore, n$1);
			})), t$2.Au.jr(), t$2.Eu = /* @__PURE__ */ new Map(), t$2.du = new SortedMap(DocumentKey.comparator);
...
function __PRIVATE_syncEngineGetActiveClients(e) {
	return function __PRIVATE_localStoreGetActiveClients(e$1) {
		return __PRIVATE_debugCast(__PRIVATE_debugCast(e$1).persistence).Ps();
	}(__PRIVATE_debugCast(e).localStore);
}
/** Applies a query target change from a different tab. */
async function __PRIVATE_syncEngineApplyTargetState(e, t, n, r) {
	const i = __PRIVATE_debugCast(e);
	if (i.fu) return void __PRIVATE_logDebug(nn, "Ignoring unexpected query state notification.");
	const s = i.Tu.get(t);
...
/** Adds or removes Watch targets for queries from different tabs. */ async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
	...
	if (r.fu) {
		for (const e$1 of t) {
			if (r.Tu.has(e$1) && r.sharedClientState.isActiveQueryTarget(e$1)) {
				__PRIVATE_logDebug(nn, "Adding an already active target " + e$1);
				continue;
			}
		...
		for (const e$1 of n) r.Tu.has(e$1) && await __PRIVATE_localStoreReleaseTarget(r.localStore, e$1, !1).then((() => {
	...
	(async function __PRIVATE_loadBundleImpl(e$1, t$1, n$1) {
		try {
			...
			if (await function __PRIVATE_localStoreHasNewerBundle(e$2, t$2) {
				...
				return n$2.persistence.runTransaction("hasNewerBundle", "readonly", ((e$3) => n$2.Ti.getBundleMetadata(e$3, t$2.id))).then(((e$3) => !!e$3 && e$3.createTime.compareTo(r$2) >= 0));
			...
			let s = await t$1.Su();
			for (; s;) {
				const e$2 = await i.Wa(s);
				e$2 && n$1._updateProgress(e$2), s = await t$1.Su();
			}
			const o = await i.za(e$1.localStore);
			return await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e$1, o.Ja, void 0), await function __PRIVATE_localStoreSaveBundle(e$2, t$2) {
				...
				return n$2.persistence.runTransaction("Save bundle", "readwrite", ((e$3) => n$2.Ti.saveBundleMetadata(e$3, t$2)));
			}(e$1.localStore, r$1), n$1._completeWith(o.progress), Promise.resolve(o.ja);
		} catch (e$2) {
			return __PRIVATE_logWarn(nn, `Loading bundle failed with ${e$2}`), n$1._failWith(e$2), Promise.resolve(/* @__PURE__ */ new Set());
		}
	})(r, t, n).then(((e$1) => {
...
*/ var __PRIVATE_IndexedDbOfflineComponentProvider = class extends __PRIVATE_MemoryOfflineComponentProvider {
	...
	async initialize(e) {
		await super.initialize(e), await this.Mu.initialize(this, e), await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Mu.syncEngine), await __PRIVATE_fillWritePipeline(this.Mu.remoteStore), await this.persistence.ji((() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve())));
	}
	vu(e) {
		return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
	}
...
*/ var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
	constructor(e, t) {
		super(e, t, !1), this.Mu = e, this.cacheSizeBytes = t, this.synchronizeTabs = !0;
	}
	async initialize(e) {
		...
		this.sharedClientState instanceof __PRIVATE_WebStorageSharedClientState && (this.sharedClientState.syncEngine = {
			...
			await __PRIVATE_syncEngineApplyPrimaryState(this.Mu.syncEngine, e$1), this.gcScheduler && (e$1 && !this.gcScheduler.started ? this.gcScheduler.start() : e$1 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e$1 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e$1 || this.indexBackfillerScheduler.stop());
		}));
	}
	bu(e) {
...
*/ var OnlineComponentProvider = class {
	...
	async terminate() {
		var e, t;
		await async function __PRIVATE_remoteStoreShutdown(e$1) {
			const t$1 = __PRIVATE_debugCast(e$1);
			__PRIVATE_logDebug(Xt, "RemoteStore shutting down."), t$1.Ia.add(5), await __PRIVATE_disableNetworkInternal(t$1), t$1.Ea.shutdown(), t$1.Aa.set("Unknown");
...
*/ var __PRIVATE_BundleReaderImpl = class {
	constructor(e, t) {
		this.Nu = e, this.serializer = t, this.metadata = new __PRIVATE_Deferred(), this.buffer = new Uint8Array(), this.Bu = function __PRIVATE_newTextDecoder() {
			return new TextDecoder("utf-8");
		}(), this.Lu().then(((e$1) => {
			e$1 && e$1.Qa() ? this.metadata.resolve(e$1.qa.metadata) : this.metadata.reject(/* @__PURE__ */ new Error(`The first element of the bundle is not a metadata, it is\n             ${JSON.stringify(null == e$1 ? void 0 : e$1.qa)}`));
	...
	*/ async ku() {
		for (; this.$u() < 0;) if (await this.Uu()) break;
	...
	*/ async Qu(e) {
		for (; this.buffer.length < e;) await this.Uu() && this.qu("Reached the end of bundle when more is expected.");
		const t = this.Bu.decode(this.buffer.slice(0, e));
		return this.buffer = this.buffer.slice(e), t;
	}
	qu(e) {
		throw this.Nu.cancel(), /* @__PURE__ */ new Error(`Invalid bundle format: ${e}`);
	}
	/**
...
var Transaction$2 = class {
	...
	recordVersion(e) {
		...
		if (e.isFoundDocument()) t = e.version;
			...
			if (!e.isNoDocument()) throw fail(50498, { Wu: e.constructor.name });
...
*/ var __PRIVATE_TransactionRunner = class {
	constructor(e, t, n, r, i) {
		this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r, this.deferred = i, this.Gu = n.maxAttempts, this.F_ = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry");
	}
...
var FirestoreClient = class {
	constructor(e, t, n, r, i) {
		this.authCredentials = e, this.appCheckCredentials = t, this.asyncQueue = n, this.databaseInfo = r, this.user = User.UNAUTHENTICATED, this.clientId = __PRIVATE_AutoId.newId(), this.authCredentialListener = () => Promise.resolve(), this.appCheckCredentialListener = () => Promise.resolve(), this._uninitializedComponentsProvider = i, this.authCredentials.start(n, (async (e$1) => {
			__PRIVATE_logDebug(rn, "Received user=", e$1.uid), await this.authCredentialListener(e$1), this.user = e$1;
		})), this.appCheckCredentials.start(n, ((e$1) => (__PRIVATE_logDebug(rn, "Received new app check token=", e$1), this.appCheckCredentialListener(e$1, this.user))));
	}
	get configuration() {
		return {
...
async function __PRIVATE_setOfflineComponentProvider(e, t) {
	...
	e.setCredentialChangeListener((async (e$1) => {
		...
		__PRIVATE_logWarn("Terminating Firestore due to IndexedDb database deletion"), e.terminate().then((() => {
			...
			__PRIVATE_logWarn("Terminating Firestore due to IndexedDb database deletion failed", e$1);
		}));
...
async function __PRIVATE_setOnlineComponentProvider(e, t) {
	...
	__PRIVATE_logDebug(rn, "Initializing OnlineComponentProvider"), await t.initialize(n, e.configuration), e.setCredentialChangeListener(((e$1) => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, e$1))), e.setAppCheckTokenChangeListener(((e$1, n$1) => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, n$1))), e._onlineComponents = t;
}
/**
...
/** Enables the network connection and re-enqueues all pending operations. */ function __PRIVATE_firestoreClientEnableNetwork(e) {
	return e.asyncQueue.enqueue((async () => {
		...
		return t.setNetworkEnabled(!0), function __PRIVATE_remoteStoreEnableNetwork(e$1) {
			const t$1 = __PRIVATE_debugCast(e$1);
			return t$1.Ia.delete(0), __PRIVATE_enableNetworkInternal(t$1);
		}(n);
	}));
}
/** Disables the network connection. Pending operations will not complete. */ function __PRIVATE_firestoreClientDisableNetwork(e) {
	return e.asyncQueue.enqueue((async () => {
		...
		return t.setNetworkEnabled(!1), async function __PRIVATE_remoteStoreDisableNetwork(e$1) {
			const t$1 = __PRIVATE_debugCast(e$1);
			t$1.Ia.add(0), await __PRIVATE_disableNetworkInternal(t$1), t$1.Aa.set("Offline");
		}(n);
	}));
}
/**
...
function __PRIVATE_firestoreClientGetDocumentViaSnapshotListener(e, t, n = {}) {
	...
	return e.asyncQueue.enqueueAndForget((async () => function __PRIVATE_readDocumentViaSnapshotListener(e$1, t$1, n$1, r$1, i) {
		const s = new __PRIVATE_AsyncObserver({
			next: (_) => {
				s.Ou(), t$1.enqueueAndForget((() => __PRIVATE_eventManagerUnlisten(e$1, o)));
...
function __PRIVATE_firestoreClientGetDocumentsFromLocalCache(e, t) {
	...
	return e.asyncQueue.enqueueAndForget((async () => async function __PRIVATE_executeQueryFromCache(e$1, t$1, n$1) {
		try {
			const r = await __PRIVATE_localStoreExecuteQuery(e$1, t$1, !0), i = new __PRIVATE_View(t$1, r.qs), s = i.nu(r.documents), o = i.applyChanges(s, !1);
	...
	return e.asyncQueue.enqueueAndForget((async () => {
		try {
			...
			r.resolve(async function __PRIVATE_invokeRunAggregationQueryRpc(e$1, t$1, n$1) {
				var r$1;
				const i$1 = __PRIVATE_debugCast(e$1), { request: s, ft: o, parent: _ } = __PRIVATE_toRunAggregationQueryRequest(i$1.serializer, __PRIVATE_queryToAggregateTarget(t$1), n$1);
				i$1.connection.Qo || delete s.parent;
				const a = (await i$1.Jo("RunAggregationQuery", i$1.serializer.databaseId, _, s, 1)).filter(((e$2) => !!e$2.result));
				__PRIVATE_hardAssert(1 === a.length, 64727);
				const u = null === (r$1 = a[0].result) || void 0 === r$1 ? void 0 : r$1.aggregateFields;
				return Object.keys(u).reduce(((e$2, t$2) => (e$2[o[t$2]] = u[t$2], e$2)), {});
			}(i, t, n));
		} catch (e$1) {
			r.reject(e$1);
		}
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
	...
	return e.asyncQueue.enqueueAndForget((async () => function __PRIVATE_addSnapshotsInSyncListener(e$1, t$1) {
		__PRIVATE_debugCast(e$1).Da.add(t$1), t$1.next();
	}(await __PRIVATE_getEventManager(e), n))), () => {
		n.Ou(), e.asyncQueue.enqueueAndForget((async () => function __PRIVATE_removeSnapshotsInSyncListener(e$1, t$1) {
			__PRIVATE_debugCast(e$1).Da.delete(t$1);
		}(await __PRIVATE_getEventManager(e), n)));
	};
}
/**
...
function __PRIVATE_firestoreClientGetNamedQuery(e, t) {
	return e.asyncQueue.enqueue((async () => function __PRIVATE_localStoreGetNamedQuery(e$1, t$1) {
		...
		return n.persistence.runTransaction("Get named query", "readonly", ((e$2) => n.Ti.getNamedQuery(e$2, t$1)));
...
function __PRIVATE_firestoreClientSetPersistentCacheIndexAutoCreationEnabled(e, t) {
	return e.asyncQueue.enqueue((async () => function __PRIVATE_localStoreSetIndexAutoCreationEnabled(e$1, t$1) {
		__PRIVATE_debugCast(e$1).Cs.Rs = t$1;
	}(await __PRIVATE_getLocalStore(e), t)));
}
...
* limitations under the License.
*/
var on = "firestore.googleapis.com", _n = !0;
/**
...
*/ function connectFirestoreEmulator(e, t, n, r = {}) {
	...
	const s = isCloudWorkstation(t), o = e._getSettings(), _ = Object.assign(Object.assign({}, o), { emulatorOptions: e._getEmulatorOptions() }), a = `${t}:${n}`;
	...
	if (!deepEqual(u, _) && (e._setSettings(u), r.mockUserToken)) {
		...
		if ("string" == typeof r.mockUserToken) t$1 = r.mockUserToken, n$1 = User.MOCK_USER;
			...
			t$1 = createMockUserToken(r.mockUserToken, null === (i = e._app) || void 0 === i ? void 0 : i.options.projectId);
			const s$1 = r.mockUserToken.sub || r.mockUserToken.user_id;
			if (!s$1) throw new FirestoreError(N.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
			n$1 = new User(s$1);
		}
...
var __PRIVATE_AsyncQueueImpl = class {
	constructor(e = Promise.resolve()) {
		this.Zu = [], this.Xu = !1, this.ec = [], this.tc = null, this.nc = !1, this.rc = !1, this.sc = [], this.F_ = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry"), this.oc = () => {
			...
			e$1 && __PRIVATE_logDebug(an, "Visibility state changed to " + e$1.visibilityState), this.F_.y_();
		}, this._c = e;
		const t = getDocument();
	...
	*/ async cc() {
	...
	uc(e) {
		const t = this._c.then((() => (this.nc = !0, e().catch(((e$1) => {
			this.tc = e$1, this.nc = !1;
			throw __PRIVATE_logError("INTERNAL UNHANDLED ERROR: ", __PRIVATE_getMessageOrStack(e$1)), e$1;
		})).then(((e$1) => (this.nc = !1, e$1))))));
		return this._c = t, t;
	}
	enqueueAfterDelay(e, t, n) {
		this.ac(), this.sc.indexOf(e) > -1 && (t = 0);
		const r = DelayedOperation.createAndSchedule(this, e, t, n, ((e$1) => this.lc(e$1)));
	...
	*/ Ic(e) {
		return this.Pc().then((() => {
			this.ec.sort(((e$1, t) => e$1.targetTimeMs - t.targetTimeMs));
...
*/ function initializeFirestore(e, t, n) {
	...
	if (r.isInitialized(n)) {
		const e$1 = r.getImmediate({ identifier: n });
		if (deepEqual(r.getOptions(n), t)) return e$1;
...
function getFirestore(e, n) {
	const r = "object" == typeof e ? e : getApp(), i = "string" == typeof e ? e : n || ut, s = _getProvider(r, "firestore").getImmediate({ identifier: i });
	if (!s._initialized) {
...
function __PRIVATE_configureFirestore(e) {
	var t, n, r;
	const i = e._freezeSettings(), s = function __PRIVATE_makeDatabaseInfo(e$1, t$1, n$1, r$1) {
		return new DatabaseInfo(e$1, t$1, n$1, r$1.host, r$1.ssl, r$1.experimentalForceLongPolling, r$1.experimentalAutoDetectLongPolling, __PRIVATE_cloneLongPollingOptions(r$1.experimentalLongPollingOptions), r$1.useFetchStreams, r$1.isUsingEmulator);
	...
	}), e._firestoreClient = new FirestoreClient(e._authCredentials, e._appCheckCredentials, e._queue, s, e._componentsProvider && function __PRIVATE_buildComponentProvider(e$1) {
		const t$1 = null == e$1 ? void 0 : e$1._online.build();
		return {
			_offline: null == e$1 ? void 0 : e$1._offline.build(t$1),
			_online: t$1
		};
...
function enableIndexedDbPersistence(e, t) {
	...
	return __PRIVATE_setPersistenceProviders(e, OnlineComponentProvider.provider, { build: (e$1) => new __PRIVATE_IndexedDbOfflineComponentProvider(e$1, n.cacheSizeBytes, null == t ? void 0 : t.forceOwnership) }), Promise.resolve();
}
/**
...
var __PRIVATE_ArrayUnionFieldValueImpl = class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), r = new __PRIVATE_ArrayUnionTransformOperation(this.vc.map(((e$1) => __PRIVATE_parseData(e$1, t))));
...
var __PRIVATE_ArrayRemoveFieldValueImpl = class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), r = new __PRIVATE_ArrayRemoveTransformOperation(this.vc.map(((e$1) => __PRIVATE_parseData(e$1, t))));
		return new FieldTransform(e.path, r);
	}
	isEqual(e) {
...
/** Parse update data from an update() call. */ function __PRIVATE_parseUpdateData(e, t, n, r) {
	...
	forEach(r, ((e$1, r$1) => {
		const _ = __PRIVATE_fieldPathFromDotSeparatedString(t, e$1, n);
		r$1 = getModularInstance(r$1);
		const a = i.gc(_);
		if (r$1 instanceof __PRIVATE_DeleteFieldValueImpl) s.push(_);
		else {
			const e$2 = __PRIVATE_parseData(r$1, a);
			null != e$2 && (s.push(_), o.set(_, e$2));
		}
	}));
 ...
 /**
	...
	*/
	return function __PRIVATE_parseSentinelFieldValue(e$1, t$1) {
		if (!__PRIVATE_isWrite(t$1.Ec)) throw t$1.wc(`${e$1._methodName}() can only be used with update() and set()`);
		if (!t$1.path) throw t$1.wc(`${e$1._methodName}() is not currently supported inside arrays`);
	...
	if (t.path && t.fieldMask.push(t.path), e instanceof Array) {
		...
		return function __PRIVATE_parseArray(e$1, t$1) {
			...
			let r = 0;
			for (const i of e$1) {
				let e$2 = __PRIVATE_parseData(i, t$1.yc(r));
	...
	return function __PRIVATE_parseScalarValue(e$1, t$1) {
		...
		if (e$1 instanceof DocumentReference) {
			...
			if (!r.isEqual(n)) throw t$1.wc(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
		...
		*/
		return function __PRIVATE_parseVectorValue(e$2, t$2) {
			return { mapValue: { fields: {
				[ct]: { stringValue: Pt },
				[Tt]: { arrayValue: { values: e$2.toArray().map(((e$3) => {
					if ("number" != typeof e$3) throw t$2.wc("VectorValues must only contain numeric values.");
					return __PRIVATE_toDouble(t$2.serializer, e$3);
				})) } }
			} } };
		}(e$1, t$1);
		throw t$1.wc(`Unsupported field value: ${__PRIVATE_valueDescription(e$1)}`);
	}(e, t);
}
function __PRIVATE_parseObject(e, t) {
	const n = {};
	return isEmpty(e) ? t.path && t.path.length > 0 && t.fieldMask.push(t.path) : forEach(e, ((e$1, r) => {
		const i = __PRIVATE_parseData(r, t.Vc(e$1));
		null != i && (n[e$1] = i);
	})), { mapValue: { fields: n } };
}
...
var AbstractUserDataWriter = class {
	...
	*/ convertVectorValue(e) {
		var t, n, r;
		return new VectorValue(null === (r = null === (n = null === (t = e.fields) || void 0 === t ? void 0 : t[Tt].arrayValue) || void 0 === n ? void 0 : n.values) || void 0 === r ? void 0 : r.map(((e$1) => __PRIVATE_normalizeNumber(e$1.doubleValue))));
	}
	convertGeoPoint(e) {
...
function onSnapshot(e, ...t) {
	...
	if (__PRIVATE_isPartialObserver(t[o])) {
		const e$1 = t[o];
		t[o] = null === (n = e$1.next) || void 0 === n ? void 0 : n.bind(e$1), t[o + 1] = null === (r = e$1.error) || void 0 === r ? void 0 : r.bind(e$1), t[o + 2] = null === (i = e$1.complete) || void 0 === i ? void 0 : i.bind(e$1);
	}
	let a, u, c;
	if (e instanceof DocumentReference) u = __PRIVATE_cast(e.firestore, Firestore), c = __PRIVATE_newQueryForPath(e._key.path), a = {
		next: (n$1) => {
			t[o] && t[o](__PRIVATE_convertToDocSnapshot(u, e, n$1));
		},
		error: t[o + 1],
		complete: t[o + 2]
	};
		...
		u = __PRIVATE_cast(n$1.firestore, Firestore), c = n$1._query;
		const r$1 = new __PRIVATE_ExpUserDataWriter(u);
		a = {
			next: (e$1) => {
				t[o] && t[o](new QuerySnapshot(u, r$1, n$1, e$1));
			},
			error: t[o + 1],
			complete: t[o + 2]
	...
	return function __PRIVATE_firestoreClientListen(e$1, t$1, n$1, r$1) {
		...
		return e$1.asyncQueue.enqueueAndForget((async () => __PRIVATE_eventManagerListen(await __PRIVATE_getEventManager(e$1), s$1))), () => {
			i$1.Ou(), e$1.asyncQueue.enqueueAndForget((async () => __PRIVATE_eventManagerUnlisten(await __PRIVATE_getEventManager(e$1), s$1)));
		};
	...
	if ("DocumentSnapshot" === i.bundleSource) {
		...
		return function __PRIVATE_onSnapshotDocumentSnapshotBundle(e$2, t$1, n$1, r$1, i$1) {
			...
			return loadBundle(e$2, t$1.bundle).then((() => {
				if (!o$1) s$1 = onSnapshot(new DocumentReference(e$2, i$1 || null, DocumentKey.fromPath(t$1.bundleName)), n$1 || {}, r$1);
			})).catch(((e$3) => (r$1.error && r$1.error(e$3), () => {}))), () => {
				o$1 || (o$1 = !0, s$1 && s$1());
			};
		}(r, i, s, e$1, n[o]);
...
*/ function getAggregateFromServer(e, t) {
	...
	return __PRIVATE_firestoreClientRunAggregateQuery(r, e._query, i).then(((t$1) => function __PRIVATE_convertToAggregateQuerySnapshot(e$1, t$2, n$1) {
		return new AggregateQuerySnapshot(t$2, new __PRIVATE_ExpUserDataWriter(e$1), n$1);
	}(n, e, t$1)));
}
var __PRIVATE_MemoryLocalCacheImpl = class {
	constructor(e) {
		this.kind = "memory", this._onlineComponentProvider = OnlineComponentProvider.provider, (null == e ? void 0 : e.garbageCollector) ? this._offlineComponentProvider = e.garbageCollector._offlineComponentProvider : this._offlineComponentProvider = { build: () => new __PRIVATE_LruGcMemoryOfflineComponentProvider(void 0) };
	}
	toJSON() {
...
*/ function runTransaction(e, t, n) {
	...
	return function __PRIVATE_firestoreClientTransaction(e$1, t$1, n$1) {
		...
		return e$1.asyncQueue.enqueueAndForget((async () => {
			...
			new __PRIVATE_TransactionRunner(e$1.asyncQueue, i, n$1, t$1, r$1).zu();
		})), r$1.promise;
...
*/ function setIndexConfiguration(e, t) {
	...
	return __PRIVATE_firestoreClientSetIndexConfiguration(n, function __PRIVATE_parseIndexes(e$1) {
		const t$1 = "string" == typeof e$1 ? function __PRIVATE_tryParseJson(e$2) {
			try {
				return JSON.parse(e$2);
			} catch (e$3) {
				throw new FirestoreError(N.INVALID_ARGUMENT, "Failed to parse JSON: " + (null == e$3 ? void 0 : e$3.message));
			}
		}(e$1) : e$1, n$1 = [];
		if (Array.isArray(t$1.indexes)) for (const e$2 of t$1.indexes) {
			const t$2 = __PRIVATE_tryGetString(e$2, "collectionGroup"), r = [];
			if (Array.isArray(e$2.fields)) for (const t$3 of e$2.fields) {
				...
				"CONTAINS" === t$3.arrayConfig ? r.push(new IndexSegment(e$3, 2)) : "ASCENDING" === t$3.order ? r.push(new IndexSegment(e$3, 0)) : "DESCENDING" === t$3.order && r.push(new IndexSegment(e$3, 1));
			}
			n$1.push(new FieldIndex(FieldIndex.UNKNOWN_ID, t$2, r, IndexState.empty()));
		}
		return n$1;
	}(t));
}
...
*/ function _internalAggregationQueryToProtoRunAggregationQueryRequest(e, t) {
	var n;
	const r = __PRIVATE_mapToArray(t, ((e$1, t$1) => new __PRIVATE_AggregateImpl(t$1, e$1.aggregateType, e$1._internalFieldPath))), i = null === (n = ensureFirestoreConfigured(__PRIVATE_cast(e.firestore, Firestore))._onlineComponents) || void 0 === n ? void 0 : n.datastore.serializer;
